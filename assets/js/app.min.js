...
$(document).foundation({
  ...
  $(this).find(".modal-title").html("ОСТАВЬТЕ ЗАЯВКУ И МЫ ВАМ ПЕРЕЗВОНИМ"),
  $(this).find(".modal-body").html(""),
  $(this).find(".btn-orange").text("ОСТАВИТЬ ЗАЯВКУ"),
  $(this).find('input[name="block-name"]').val(""),
  $(this).find('input[name="calculator[fasad-material]"]').val(""),
  $(this).find('input[name="calculator[table-material]"]').val(""),
  $(this).find('input[name="calculator[length]"]').val(""),
   $(this).find('input[name="calculator[box-count]"]').val(""),
   $(this).find('input[name="succ_message"]').val("0"),
   $(this).find('input[name="designer"]').val("")
