function FastClick(t, e) {
  ...
  if (e = e || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = e.touchBoundary || 10, this.layer = t, this.tapDelay = e.tapDelay || 200, !FastClick.notNeeded(t)) {
    for (var s = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], a = this, r = 0, o = s.length; o > r; r++) a[s[r]] = n(a[s[r]], a);
  ...
  function i(t, e, n) {
    ...
    if ("string" == typeof e) {
      if (oe.test(e)) return K.filter(e, t, n);
      e = K.filter(e, t)
    }
  ...
  function r() {
    G.removeEventListener("DOMContentLoaded", r, !1), t.removeEventListener("load", r, !1), K.ready()
  }
  ...
  function m(t, e) {
    ...
    if (1 === e.nodeType) {
      if (ve.hasData(t) && (a = ve.access(t), r = ve.set(e, a), c = a.events)) {
        ...
        for (s in c)
          for (n = 0, i = c[s].length; i > n; n++) K.event.add(e, s, c[s][n])
      }
      _e.hasData(t) && (o = _e.access(t), l = K.extend({}, o), _e.set(e, l))
    }
  }
  ...
  function y(e, n) {
    var i, s = K(n.createElement(e)).appendTo(n.body),
      a = t.getDefaultComputedStyle && (i = t.getDefaultComputedStyle(s[0])) ? i.display : K.css(s[0], "display");
    return s.detach(), a
  }
  ...
  function b(t) {
    var e = G,
      n = Pe[t];
    return n || (n = y(t, e), "none" !== n && n || (Oe = (Oe || K("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Oe[0].contentDocument, e.write(), e.close(), n = y(t, e), Oe.detach()), Pe[t] = n), n
  }

  function x(t, e, n) {
    var i, s, a, r, o = t.style;
    return n = n || Be(t), n && (r = n.getPropertyValue(e) || n[e]), n && ("" !== r || K.contains(t.ownerDocument, t) || (r = K.style(t, e)), Re.test(r) && ze.test(e) && (i = o.width, s = o.minWidth, a = o.maxWidth, o.minWidth = o.maxWidth = o.width = r, r = n.width, o.width = i, o.minWidth = s, o.maxWidth = a)), void 0 !== r ? r + "" : r
  }
  ...
  function F(t, e) {
    if (e in t) return e;
    for (var n = e[0].toUpperCase() + e.slice(1), i = e, s = Ve.length; s--;)
      if (e = Ve[s] + n, e in t) return e;
    return i
  }
  ...
  function k(t, e, n, i, s) {
    for (var a = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, r = 0; 4 > a; a += 2) "margin" === n && (r += K.css(t, n + we[a], !0, s)), i ? ("content" === n && (r -= K.css(t, "padding" + we[a], !0, s)), "margin" !== n && (r -= K.css(t, "border" + we[a] + "Width", !0, s))) : (r += K.css(t, "padding" + we[a], !0, s), "padding" !== n && (r += K.css(t, "border" + we[a] + "Width", !0, s)));
    return r
  }
  ...
  function A(t, e, n) {
    var i = !0,
      ...
      a = Be(t),
      r = "border-box" === K.css(t, "boxSizing", !1, a);
    if (0 >= s || null == s) {
      if (s = x(t, e, a), (0 > s || null == s) && (s = t.style[e]), Re.test(s)) return s;
      i = r && (Z.boxSizingReliable() || s === t.style[e]), s = parseFloat(s) || 0
    }
    return s + k(t, e, n || (r ? "border" : "content"), i, a) + "px"
  }

  function S(t, e) {
    for (var n, i, s, a = [], r = 0, o = t.length; o > r; r++) i = t[r], i.style && (a[r] = ve.get(i, "olddisplay"), n = i.style.display, e ? (a[r] || "none" !== n || (i.style.display = ""), "" === i.style.display && Fe(i) && (a[r] = ve.access(i, "olddisplay", b(i.nodeName)))) : (s = Fe(i), "none" === n && s || ve.set(i, "olddisplay", s ? n : K.css(i, "display"))));
    for (r = 0; o > r; r++) i = t[r], i.style && (e && "none" !== i.style.display && "" !== i.style.display || (i.style.display = e ? a[r] || "" : "none"));
    return t
  }
  ...
  function D(t, e) {
    ...
    for (e = e ? 1 : 0; 4 > i; i += 2 - e) n = we[i], s["margin" + n] = s["padding" + n] = t;
    return e && (s.opacity = s.width = t), s
  }

  function E(t, e, n) {
    for (var i, s = (nn[e] || []).concat(nn["*"]), a = 0, r = s.length; r > a; a++)
      if (i = s[a].call(n, e, t)) return i
  }

  function j(t, e, n) {
    var i, s, a, r, o, l, c, d, u = this,
      h = {},
      f = t.style,
      p = t.nodeType && Fe(t),
      g = ve.get(t, "fxshow");
    ...
    })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = K.css(t, "display"), d = "none" === c ? ve.get(t, "olddisplay") || b(t.nodeName) : c, "inline" === d && "none" === K.css(t, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", u.always(function() {
    ...
    if (K.isEmptyObject(h)) "inline" === ("none" === c ? b(t.nodeName) : c) && (f.display = c);
    else {
      g ? "hidden" in g && (p = g.hidden) : g = ve.access(t, "fxshow", {}), a && (g.hidden = !p), p ? K(t).show() : u.done(function() {
        K(t).hide()
      }), u.done(function() {
        var e;
        ve.remove(t, "fxshow");
      ...
      for (i in h) r = E(p ? g[i] : 0, i, u), i in g || (g[i] = r.start, p && (r.end = r.start, r.start = "width" === i || "height" === i ? 1 : 0))
    }
  }
  ...
  function M(t, e) {
    var n, i, s, a, r;
    for (n in t)
      if (i = K.camelCase(n), s = e[i], a = t[n], K.isArray(a) && (s = a[1], a = t[n] = a[0]), n !== i && (t[i] = a, delete t[n]), r = K.cssHooks[i], r && "expand" in r) {
  ...
  function q(t, e, n) {
    var i, s, a = 0,
      ...
      l = function() {
        if (s) return !1;
        for (var e = Ze || T(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, a = 1 - i, r = 0, l = c.tweens.length; l > r; r++) c.tweens[r].run(a);
        return o.notifyWith(t, [c, a, n]), 1 > a && l ? n : (o.resolveWith(t, [c]), !1)
      },
      c = o.promise({
        elem: t,
        props: K.extend({}, e),
      ...
      d = c.props;
    for (M(d, c.opts.specialEasing); r > a; a++)
      if (i = en[a].call(c, t, d, c.opts)) return i;
    return K.map(d, E, c), K.isFunction(c.opts.start) && c.opts.start.call(t, c), K.fx.timer(K.extend(l, {
      elem: t,
      anim: c,
      queue: c.opts.queue
  ...
  function N(t, e, n, i) {
    function s(o) {
      ...
      return a[o] = !0, K.each(t[o] || [], function(t, o) {
        var c = o(e, n, i);
        return "string" != typeof c || r || a[c] ? r ? !(l = c) : void 0 : (e.dataTypes.unshift(c), s(c), !1)
      }), l
    }
    var a = {},
      r = t === wn;
  ...
  function H(t, e, n) {
    for (var i, s, a, r, o = t.contents, l = t.dataTypes;
  ...
  function P(t, e, n, i) {
    ...
    if (K.isArray(e)) K.each(e, function(e, s) {
      n || An.test(t) ? i(t, s) : P(t + "[" + ("object" == typeof s ? e : "") + "]", s, n, i)
    });
    else if (n || "object" !== K.type(e)) i(t, e);
    else
      for (s in e) P(t + "[" + s + "]", e[s], n, i)
  }
  ...
  K.fn = K.prototype = {
    ...
    var t, e, n, i, s, a, r = arguments[0] || {},
      o = 1,
      l = arguments.length,
      c = !1;
    for ("boolean" == typeof r && (c = r, r = arguments[o] || {}, o++), "object" == typeof r || K.isFunction(r) || (r = {}), o === l && (r = this, o--); l > o; o++)
      if (null != (t = arguments[o]))
        for (e in t) n = r[e], i = t[e], r !== i && (c && i && (K.isPlainObject(i) || (s = K.isArray(i))) ? (s ? (s = !1, a = n && K.isArray(n) ? n : []) : a = n && K.isPlainObject(n) ? n : {}, r[e] = K.extend(c, a, i)) : void 0 !== i && (r[e] = i));
    return r
  }, K.extend({
    ...
    isPlainObject: function(t) {
      return "object" !== K.type(t) || t.nodeType || K.isWindow(t) ? !1 : t.constructor && !V.call(t.constructor.prototype, "isPrototypeOf") ? !1 : !0
    },
    ...
    each: function(t, e, i) {
      ...
      if (i) {
        if (o)
          for (; r > a && (s = e.apply(t[a], i), s !== !1); a++);
        else
          for (a in t)
            if (s = e.apply(t[a], i), s === !1) break
      } else if (o)
        for (; r > a && (s = e.call(t[a], a, t[a]), s !== !1); a++);
      else
        for (a in t)
    ...
    makeArray: function(t, e) {
      var i = e || [];
      return null != t && (n(Object(t)) ? K.merge(i, "string" == typeof t ? [t] : t) : U.call(i, t)), i
    },
    ...
    grep: function(t, e, n) {
      for (var i, s = [], a = 0, r = t.length, o = !n; r > a; a++) i = !e(t[a], a), i !== o && s.push(t[a]);
      return s
    },
    map: function(t, e, i) {
      var s, a = 0,
        ...
        l = [];
      if (o)
        for (; r > a; a++) s = e(t[a], a, i), null != s && l.push(s);
      else
    ...
    proxy: function(t, e) {
      var n, i, s;
      return "string" == typeof e && (n = t[e], e = t, t = n), K.isFunction(t) ? (i = B.call(arguments, 2), s = function() {
  ...
  var se = function(t) {
    function e(t, e, n, i) {
      var s, a, r, o, l, c, u, f, p, g;
      if ((e ? e.ownerDocument || e : P) !== j && E(e), e = e || j, n = n || [], !t || "string" != typeof t) return n;
      ...
      if (q && !i) {
        if (s = _e.exec(t))
          if (r = s[1]) {
            ...
            } else if (e.ownerDocument && (a = e.ownerDocument.getElementById(r)) && H(e, a) && a.id === r) return n.push(a), n
          } else {
            if (s[2]) return K.apply(n, e.getElementsByTagName(t)), n;
            if ((r = s[3]) && x.getElementsByClassName && e.getElementsByClassName) return K.apply(n, e.getElementsByClassName(r)), n
          }
        if (x.qsa && (!I || !I.test(t))) {
          if (f = u = O, p = e, g = 9 === o && t, 1 === o && "object" !== e.nodeName.toLowerCase()) {
            for (c = k(t), (u = e.getAttribute("id")) ? f = u.replace(be, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;) c[l] = f + h(c[l]);
            p = ye.test(t) && d(e.parentNode) || e, g = c.join(",")
          }
          if (g) try {
    ...
    function c(t) {
      return i(function(e) {
        return e = +e, i(function(n, i) {
          for (var s, a = t([], n.length, e), r = a.length; r--;) n[s = a[r]] && (n[s] = !(i[s] = n[s]))
        })
      })
    }
    ...
    function f(t, e, n) {
      ...
      return e.first ? function(e, n, a) {
        ...
        if (r) {
          ...
          for (; e = e[i];)
            if (1 === e.nodeType || s) {
              if (l = e[O] || (e[O] = {}), (o = l[i]) && o[0] === z && o[1] === a) return c[2] = o[2];
    ...
    function m(t, e, n, i, s) {
      for (var a, r = [], o = 0, l = t.length, c = null != e; l > o; o++)(a = t[o]) && (!n || n(a, i, s)) && (r.push(a), c && e.push(o));
      return r
    }

    function v(t, e, n, s, a, r) {
      return s && !s[O] && (s = v(s)), a && !a[O] && (a = v(a, r)), i(function(i, r, o, l) {
        var c, d, u, h = [],
          f = [],
          p = r.length,
          v = i || g(e || "*", o.nodeType ? [o] : o, []),
          _ = !t || !i && e ? v : m(v, h, t, o, l),
          y = n ? a || (i ? t : p || s) ? [] : r : _;
        if (n && n(_, y, o, l), s)
          for (c = m(y, f), s(c, [], o, l), d = c.length; d--;)(u = c[d]) && (y[f[d]] = !(_[f[d]] = u));
        if (i) {
          if (a || t) {
            if (a) {
            ...
            for (d = y.length; d--;)(u = y[d]) && (c = a ? ee.call(i, u) : h[d]) > -1 && (i[c] = !(r[c] = u))
          }
        } else y = m(y === r ? y.splice(p, y.length) : y), a ? a(null, r, y, l) : K.apply(r, y)
      })
    }

    function _(t) {
      for (var e, n, i, s = t.length, a = w.relative[t[0].type], r = a || w.relative[" "], o = a ? 1 : 0, l = f(function(t) {
          return t === e
        }, r, !0), c = f(function(t) {
        ...
        if (n = w.relative[t[o].type]) d = [f(p(d), n)];
        else {
          if (n = w.filter[t[o].type].apply(null, t[o].matches), n[O]) {
            for (i = ++o; s > i && !w.relative[t[i].type]; i++);
            return v(o > 1 && p(d), o > 1 && h(t.slice(0, o - 1).concat({
              value: " " === t[o - 2].type ? "*" : ""
            })).replace(le, "$1"), n, i > o && _(t.slice(o, i)), s > i && _(t = t.slice(i)), s > i && h(t))
          }
          d.push(n)
        }
      return p(d)
    ...
    var b, x, w, F, C, k, A, S, $, T, D, E, j, M, q, I, N, L, H, O = "sizzle" + -new Date,
      P = t.document,
      z = 0,
      R = 0,
      B = n(),
    ...
    try {
      K.apply(Z = te.call(P.childNodes), P.childNodes), Z[P.childNodes.length].nodeType
    } catch (Fe) {
      K = {
    ...
    x = e.support = {}, C = e.isXML = function(t) {
      ...
      var e, n = t ? t.ownerDocument || t : P,
        i = n.defaultView;
      return n !== j && 9 === n.nodeType && n.documentElement ? (j = n, M = n.documentElement, q = !C(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
        E()
      ...
      }), x.getElementsByClassName = ve.test(n.getElementsByClassName) && s(function(t) {
        return t.innerHTML = "<div class='a'></div><div class='a i'></div>", t.firstChild.className = "i", 2 === t.getElementsByClassName("i").length
      }), x.getById = s(function(t) {
        return M.appendChild(t).id = O, !n.getElementsByName || !n.getElementsByName(O).length
      }), x.getById ? (w.find.ID = function(t, e) {
        if (typeof e.getElementById !== X && q) {
        ...
        return typeof e.getElementsByClassName !== X && q ? e.getElementsByClassName(t) : void 0
      }, N = [], I = [], (x.qsa = ve.test(n.querySelectorAll)) && (s(function(t) {
      ...
      })), (x.matchesSelector = ve.test(L = M.matches || M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && s(function(t) {
        x.disconnectedMatch = L.call(t, "div"), L.call(t, "[s!='']:x"), N.push("!=", oe)
      }), I = I.length && new RegExp(I.join("|")), N = N.length && new RegExp(N.join("|")), e = ve.test(M.compareDocumentPosition), H = e || ve.test(M.contains) ? function(t, e) {
        ...
        return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !x.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === P && H(P, t) ? -1 : e === n || e.ownerDocument === P && H(P, e) ? 1 : T ? ee.call(T, t) - ee.call(T, e) : 0 : 4 & i ? -1 : 1)
      } : function(t, e) {
        if (t === e) return D = !0, 0;
        var i, s = 0,
          a = t.parentNode,
          ...
          l = [t],
          c = [e];
        if (!a || !o) return t === n ? -1 : e === n ? 1 : a ? -1 : o ? 1 : T ? ee.call(T, t) - ee.call(T, e) : 0;
        if (a === o) return r(t, e);
        for (i = t; i = i.parentNode;) l.unshift(i);
        for (i = e; i = i.parentNode;) c.unshift(i);
        for (; l[s] === c[s];) s++;
        return s ? r(l[s], c[s]) : l[s] === P ? -1 : c[s] === P ? 1 : 0
      }, n) : j
    }, e.matches = function(t, n) {
      return e(t, null, null, n)
    }, e.matchesSelector = function(t, n) {
      if ((t.ownerDocument || t) !== j && E(t), n = n.replace(ue, "='$1']"), !(!x.matchesSelector || !q || N && N.test(n) || I && I.test(n))) try {
        var i = L.call(t, n);
      ...
      var n = w.attrHandle[e.toLowerCase()],
        i = n && V.call(w.attrHandle, e.toLowerCase()) ? n(t, e, !q) : void 0;
      ...
      var e, n = [],
        i = 0,
        s = 0;
      if (D = !x.detectDuplicates, T = !x.sortStable && t.slice(0), t.sort(Y), D) {
        for (; e = t[s++];) e === t[s] && (i = n.push(s));
        for (; i--;) t.splice(n[i], 1)
      }
      return T = null, t
    }, F = e.getText = function(t) {
      var e, n = "",
        i = 0,
        s = t.nodeType;
      if (s) {
      ...
      preFilter: {
        ...
        PSEUDO: function(t) {
          var e, n = !t[6] && t[2];
          return pe.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && he.test(n) && (e = k(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
        }
      },
      filter: {
        TAG: function(t) {
        ...
        CHILD: function(t, e, n, i, s) {
          ...
          return 1 === i && 0 === s ? function(t) {
            ...
            var c, d, u, h, f, p, g = a !== r ? "nextSibling" : "previousSibling",
              m = e.parentNode,
            ...
            if (m) {
              ...
              if (p = [r ? m.firstChild : m.lastChild], r && _) {
                for (d = m[O] || (m[O] = {}), c = d[t] || [], f = c[0] === z && c[1], h = c[0] === z && c[2], u = f && m.childNodes[f]; u = ++f && u && u[g] || (h = f = 0) || p.pop();)
                  if (1 === u.nodeType && ++h && u === e) {
                    d[t] = [z, f, h];
                    break
                  }
              } else if (_ && (c = (e[O] || (e[O] = {}))[t]) && c[0] === z) h = c[1];
              else
                for (;
                  (u = ++f && u && u[g] || (h = f = 0) || p.pop()) && ((o ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++h || (_ && ((u[O] || (u[O] = {}))[t] = [z, h]), u !== e)););
        ...
        PSEUDO: function(t, n) {
          ...
          return a[O] ? a(n) : a.length > 1 ? (s = [t, t, "", n], w.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function(t, e) {
            for (var i, s = a(t, n), r = s.length; r--;) i = ee.call(t, s[r]), t[i] = !(e[i] = s[r])
          }) : function(t) {
            return a(t, 0, s)
          }) : a
        }
      ...
      pseudos: {
        not: i(function(t) {
          var e = [],
            n = [],
            s = A(t.replace(le, "$1"));
          return s[O] ? i(function(t, e, n, i) {
            for (var a, r = s(t, null, i, []), o = t.length; o--;)(a = r[o]) && (t[o] = !(e[o] = a))
          }) : function(t, i, a) {
        ...
        contains: i(function(t) {
          return function(e) {
            return (e.textContent || e.innerText || F(e)).indexOf(t) > -1
          }
        }),
        lang: i(function(t) {
          return fe.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(xe, we).toLowerCase(),
            function(e) {
              var n;
              do
    ...
    return u.prototype = w.filters = w.pseudos, w.setFilters = new u, k = e.tokenize = function(t, n) {
      var i, s, a, r, o, l, c, d = W[t + " "];
      if (d) return n ? 0 : d.slice(0);
      for (o = t, l = [], c = w.preFilter; o;) {
        (!i || (s = ce.exec(o))) && (s && (o = o.slice(s[0].length) || o), l.push(a = [])), i = !1, (s = de.exec(o)) && (i = s.shift(), a.push({
          value: i,
          type: s[0].replace(le, " ")
        }), o = o.slice(i.length));
        for (r in w.filter) !(s = pe[r].exec(o)) || c[r] && !(s = c[r](s)) || (i = s.shift(), a.push({
          value: i,
          type: r,
          matches: s
        }), o = o.slice(i.length));
      ...
      return n ? o.length : o ? e.error(t) : W(t, l).slice(0)
    }, A = e.compile = function(t, e) {
      var n, i = [],
        s = [],
        a = U[t + " "];
      if (!a) {
        for (e || (e = k(t)), n = e.length; n--;) a = _(e[n]), a[O] ? i.push(a) : s.push(a);
        a = U(t, y(s, i)), a.selector = t
      }
      return a
      ...
      if (n = n || [], 1 === u.length) {
        if (a = u[0] = u[0].slice(0), a.length > 2 && "ID" === (r = a[0]).type && x.getById && 9 === e.nodeType && q && w.relative[a[1].type]) {
          if (e = (w.find.ID(r.matches[0].replace(xe, we), e) || [])[0], !e) return n;
          c && (e = e.parentNode), t = t.slice(a.shift().value.length)
        }
        for (s = pe.needsContext.test(t) ? 0 : a.length; s-- && (r = a[s], !w.relative[o = r.type]);)
          if ((l = w.find[o]) && (i = l(r.matches[0].replace(xe, we), ye.test(a[0].type) && d(e.parentNode) || e))) {
            if (a.splice(s, 1), t = i.length && h(a), !t) return K.apply(n, i), n;
            break
          }
      }
      return (c || A(t, u))(i, e, !q, n, ye.test(t) && d(e.parentNode) || e), n
    }, x.sortStable = O.split("").sort(Y).join("") === O, x.detectDuplicates = !!D, E(), x.sortDetached = s(function(t) {
  ...
  K.filter = function(t, e, n) {
    ...
    is: function(t) {
      return !!i(this, "string" == typeof t && ae.test(t) ? K(t) : t || [], !1).length
    }
  });
  var le, ce = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
    de = K.fn.init = function(t, e) {
      ...
      if ("string" == typeof t) {
        ...
        if (n[1]) {
          if (e = e instanceof K ? e[0] : e, K.merge(this, K.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : G, !0)), re.test(n[1]) && K.isPlainObject(e))
  ...
  K.extend({
    ...
    closest: function(t, e) {
      for (var n, i = 0, s = this.length, a = [], r = ae.test(t) || "string" != typeof t ? K(t, e || this.context) : 0; s > i; i++)
    ...
    K.fn[t] = function(n, i) {
      var s = K.map(this, e, n);
      return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (s = K.filter(i, s)), this.length > 1 && (he[t] || K.unique(s), ue.test(t) && s.reverse()), this.pushStack(s)
    }
  });
  var fe = /\S+/g,
    pe = {};
  K.Callbacks = function(t) {
    t = "string" == typeof t ? pe[t] || a(t) : K.extend({}, t);
    var e, n, i, s, r, o, l = [],
      c = !t.once && [],
      d = function(a) {
        for (e = t.memory && a, n = !0, o = s || 0, s = 0, r = l.length, i = !0; l && r > o; o++)
      ...
      u = {
        add: function() {
          if (l) {
            ...
            }(arguments), i ? r = l.length : e && (s = n, d(e))
          }
          return this
        },
        remove: function() {
          return l && K.each(arguments, function(t, e) {
            for (var n;
              (n = K.inArray(e, l, n)) > -1;) l.splice(n, 1), i && (r >= n && r--, o >= n && o--)
          }), this
        },
        has: function(t) {
    ...
    Deferred: function(t) {
      var e = [
            ...
            return K.Deferred(function(n) {
              K.each(e, function(e, a) {
                ...
                s[a[1]](function() {
                  ...
                  t && K.isFunction(t.promise) ? t.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[a[0] + "With"](this === i ? n.promise() : this, r ? [t] : arguments)
                })
              }), t = null
            }).promise()
          },
        ...
        s = {};
      return i.pipe = i.then, K.each(e, function(t, a) {
        var r = a[2],
          o = a[3];
    ...
    when: function(t) {
      var e, n, i, s = 0,
        a = B.call(arguments),
        r = a.length,
        o = 1 !== r || t && K.isFunction(t.promise) ? r : 0,
        l = 1 === o ? t : K.Deferred(),
        c = function(t, n, i) {
          return function(s) {
            n[t] = this, i[t] = arguments.length > 1 ? B.call(arguments) : s, i === e ? l.notifyWith(n, i) : --o || l.resolveWith(n, i)
          }
        };
      if (r > 1)
        for (e = new Array(r), n = new Array(r), i = new Array(r); r > s; s++) a[s] && K.isFunction(a[s].promise) ? a[s].promise().done(c(s, i, a)).fail(l.reject).progress(c(s, n, e)) : --o;
  ...
  K.fn.ready = function(t) {
    ...
    return ge || (ge = K.Deferred(), "complete" === G.readyState ? setTimeout(K.ready) : (G.addEventListener("DOMContentLoaded", r, !1), t.addEventListener("load", r, !1))), ge.promise(e)
  }, K.ready.promise();
  var me = K.access = function(t, e, n, i, s, a, r) {
    var o = 0,
      l = t.length,
      c = null == n;
    if ("object" === K.type(n)) {
      s = !0;
      for (o in n) K.access(t, e, o, n[o], !0, a, r)
    } else if (void 0 !== i && (s = !0, K.isFunction(i) || (r = !0), c && (r ? (e.call(t, i), e = null) : (c = e, e = function(t, e, n) {
        return c.call(K(t), n)
      })), e))
      for (; l > o; o++) e(t[o], n, r ? i : i.call(t[o], o, e(t[o], n)));
  ...
  K.acceptData = function(t) {
    ...
    set: function(t, e, n) {
      ...
      else if (K.isEmptyObject(a)) K.extend(this.cache[s], e);
      else
        for (i in e) a[i] = e[i];
      return a
    },
    ...
    remove: function(t, e) {
      ...
      if (void 0 === e) this.cache[a] = {};
        ...
        K.isArray(e) ? i = e.concat(e.map(K.camelCase)) : (s = K.camelCase(e), e in r ? i = [e, s] : (i = s, i = i in r ? [i] : i.match(fe) || [])), n = i.length;
        for (; n--;) delete r[i[n]]
      }
    },
    hasData: function(t) {
  ...
  K.extend({
    ...
    data: function(t, e) {
      var n, i, s, a = this[0],
        r = a && a.attributes;
      if (void 0 === t) {
        if (this.length && (s = _e.get(a), 1 === a.nodeType && !ve.get(a, "hasDataAttrs"))) {
          for (n = r.length; n--;) r[n] && (i = r[n].name, 0 === i.indexOf("data-") && (i = K.camelCase(i.slice(5)), l(a, i, s[i])));
      ...
      return "object" == typeof t ? this.each(function() {
        ...
        if (a && void 0 === e) {
          if (n = _e.get(a, t), void 0 !== n) return n;
          if (n = _e.get(a, i), void 0 !== n) return n;
    ...
    dequeue: function(t, e) {
      ...
      "inprogress" === s && (s = n.shift(), i--), s && ("fx" === e && n.unshift("inprogress"), delete a.stop, s.call(t, r, a)), !i && a && a.empty.fire()
    },
    ...
    promise: function(t, e) {
      ...
      for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; r--;) n = ve.get(a[r], t + "queueHooks"), n && n.empty && (i++, n.empty.add(o));
  ...
  K.event = {
    ...
    add: function(t, e, n, i, s) {
      var a, r, o, l, c, d, u, h, f, p, g, m = ve.get(t);
      if (m)
        for (n.handler && (a = n, n = a.handler, s = a.selector), n.guid || (n.guid = K.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function(e) {
            return typeof K !== ke && K.event.triggered !== e.type ? K.event.dispatch.apply(t, arguments) : void 0
          }), e = (e || "").match(fe) || [""], c = e.length; c--;) o = Te.exec(e[c]) || [], f = g = o[1], p = (o[2] || "").split(".").sort(), f && (u = K.event.special[f] || {}, f = (s ? u.delegateType : u.bindType) || f, u = K.event.special[f] || {}, d = K.extend({
          type: f,
          origType: g,
          data: i,
          handler: n,
          ...
          namespace: p.join(".")
        }, a), (h = l[f]) || (h = l[f] = [], h.delegateCount = 0, u.setup && u.setup.call(t, i, p, r) !== !1 || t.addEventListener && t.addEventListener(f, r, !1)), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), s ? h.splice(h.delegateCount++, 0, d) : h.push(d), K.event.global[f] = !0)
    },
    remove: function(t, e, n, i, s) {
      var a, r, o, l, c, d, u, h, f, p, g, m = ve.hasData(t) && ve.get(t);
      if (m && (l = m.events)) {
        for (e = (e || "").match(fe) || [""], c = e.length; c--;)
          if (o = Te.exec(e[c]) || [], f = g = o[1], p = (o[2] || "").split(".").sort(), f) {
            for (u = K.event.special[f] || {}, f = (i ? u.delegateType : u.bindType) || f, h = l[f] || [], o = o[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = a = h.length; a--;) d = h[a], !s && g !== d.origType || n && n.guid !== d.guid || o && !o.test(d.namespace) || i && i !== d.selector && ("**" !== i || !d.selector) || (h.splice(a, 1), d.selector && h.delegateCount--, u.remove && u.remove.call(t, d));
            r && !h.length && (u.teardown && u.teardown.call(t, p, m.handle) !== !1 || K.removeEvent(t, f, m.handle), delete l[f])
          } else
    ...
    trigger: function(e, n, i, s) {
      var a, r, o, l, c, d, u, h = [i || G],
        f = V.call(e, "type") ? e.type : e,
        p = V.call(e, "namespace") ? e.namespace.split(".") : [];
      if (r = o = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !$e.test(f + K.event.triggered) && (f.indexOf(".") >= 0 && (p = f.split("."), f = p.shift(), p.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[K.expando] ? e : new K.Event(f, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : K.makeArray(n, [e]), u = K.event.special[f] || {}, s || !u.trigger || u.trigger.apply(i, n) !== !1)) {
        if (!s && !u.noBubble && !K.isWindow(i)) {
          for (l = u.delegateType || f, $e.test(l + f) || (r = r.parentNode); r; r = r.parentNode) h.push(r), o = r;
          o === (i.ownerDocument || G) && h.push(o.defaultView || o.parentWindow || t)
        }
        for (a = 0;
          (r = h[a++]) && !e.isPropagationStopped();) e.type = a > 1 ? l : u.bindType || f, d = (ve.get(r, "events") || {})[e.type] && ve.get(r, "handle"), d && d.apply(r, n), d = c && r[c], d && d.apply && K.acceptData(r) && (e.result = d.apply(r, n), e.result === !1 && e.preventDefault());
        return e.type = f, s || e.isDefaultPrevented() || u._default && u._default.apply(h.pop(), n) !== !1 || !K.acceptData(i) || c && K.isFunction(i[f]) && !K.isWindow(i) && (o = i[c], o && (i[c] = null), K.event.triggered = f, i[f](), K.event.triggered = void 0, o && (i[c] = o)), e.result
      }
    },
    dispatch: function(t) {
      t = K.event.fix(t);
      ...
      if (o[0] = t, t.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, t) !== !1) {
        for (r = K.event.handlers.call(this, t, l), e = 0;
          (s = r[e++]) && !t.isPropagationStopped();)
          for (t.currentTarget = s.elem, n = 0;
            (a = s.handlers[n++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(a.namespace)) && (t.handleObj = a, t.data = a.data, i = ((K.event.special[a.origType] || {}).handle || a.handler).apply(s.elem, o), void 0 !== i && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
      ...
      if (o && l.nodeType && (!t.button || "click" !== t.type))
        for (; l !== this; l = l.parentNode || this)
          if (l.disabled !== !0 || "click" !== t.type) {
            for (i = [], n = 0; o > n; n++) a = e[n], s = a.selector + " ", void 0 === i[s] && (i[s] = a.needsContext ? K(s, this).index(l) >= 0 : K.find(s, this, null, [l]).length), i[s] && i.push(a);
            i.length && r.push({
              elem: l,
              handlers: i
            })
    ...
    mouseHooks: {
      ...
      filter: function(t, e) {
        ...
        return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || G, i = n.documentElement, s = n.body, t.pageX = e.clientX + (i && i.scrollLeft || s && s.scrollLeft || 0) - (i && i.clientLeft || s && s.clientLeft || 0), t.pageY = e.clientY + (i && i.scrollTop || s && s.scrollTop || 0) - (i && i.clientTop || s && s.clientTop || 0)), t.which || void 0 === a || (t.which = 1 & a ? 1 : 2 & a ? 3 : 4 & a ? 2 : 0), t
      }
    },
    fix: function(t) {
      ...
      var e, n, i, s = t.type,
        a = t,
        r = this.fixHooks[s];
      for (r || (this.fixHooks[s] = r = Se.test(s) ? this.mouseHooks : Ae.test(s) ? this.keyHooks : {}), i = r.props ? this.props.concat(r.props) : this.props, t = new K.Event(a), e = i.length; e--;) n = i[e], t[n] = a[n];
    ...
    simulate: function(t, e, n, i) {
      var s = K.extend(new K.Event, n, {
        type: t,
        isSimulated: !0,
        originalEvent: {}
      });
      i ? K.event.trigger(s, null, e) : K.event.dispatch.call(e, s), s.isDefaultPrevented() && n.preventDefault()
    }
    ...
    K.event.special[t] = {
      ...
      handle: function(t) {
        var n, i = this,
          s = t.relatedTarget,
          a = t.handleObj;
        return (!s || s !== i && !K.contains(i, s)) && (t.type = a.origType, n = a.handler.apply(this, arguments), t.type = e), n
      }
    }
  ...
  He.optgroup = He.option, He.tbody = He.tfoot = He.colgroup = He.caption = He.thead, He.th = He.td, K.extend({
    clone: function(t, e, n) {
      var i, s, a, r, o = t.cloneNode(!0),
        l = K.contains(t.ownerDocument, t);
      if (!(Z.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || K.isXMLDoc(t)))
        for (r = v(o), a = v(t), i = 0, s = a.length; s > i; i++) _(a[i], r[i]);
      if (e)
        if (n)
          for (a = a || v(t), r = r || v(o), i = 0, s = a.length; s > i; i++) m(a[i], r[i]);
        else m(t, o);
      return r = v(o, "script"), r.length > 0 && g(r, !l && v(t, "script")), o
    },
    buildFragment: function(t, e, n, i) {
      for (var s, a, r, o, l, c, d = e.createDocumentFragment(), u = [], h = 0, f = t.length; f > h; h++)
        if (s = t[h], s || 0 === s)
          if ("object" === K.type(s)) K.merge(u, s.nodeType ? [s] : s);
          else if (je.test(s)) {
        for (a = a || d.appendChild(e.createElement("div")), r = (Ee.exec(s) || ["", ""])[1].toLowerCase(), o = He[r] || He._default, a.innerHTML = o[1] + s.replace(De, "<$1></$2>") + o[2], c = o[0]; c--;) a = a.lastChild;
        K.merge(u, a.childNodes), a = d.firstChild, a.textContent = ""
      } else u.push(e.createTextNode(s));
      for (d.textContent = "", h = 0; s = u[h++];)
        if ((!i || -1 === K.inArray(s, i)) && (l = K.contains(s.ownerDocument, s), a = v(d.appendChild(s), "script"), l && g(a), n))
          for (c = 0; s = a[c++];) Ie.test(s.type || "") && n.push(s);
      return d
    },
    cleanData: function(t) {
      for (var e, n, i, s, a = K.event.special, r = 0; void 0 !== (n = t[r]); r++) {
        if (K.acceptData(n) && (s = n[ve.expando], s && (e = ve.cache[s]))) {
          if (e.events)
            for (i in e.events) a[i] ? K.event.remove(n, i) : K.removeEvent(n, i, e.handle);
    ...
    remove: function(t, e) {
      for (var n, i = t ? K.filter(t, this) : this, s = 0; null != (n = i[s]); s++) e || 1 !== n.nodeType || K.cleanData(v(n)), n.parentNode && (e && K.contains(n.ownerDocument, n) && g(v(n, "script")), n.parentNode.removeChild(n));
      return this
    },
    empty: function() {
    ...
    html: function(t) {
      return me(this, function(t) {
        ...
        if ("string" == typeof t && !Me.test(t) && !He[(Ee.exec(t) || ["", ""])[1].toLowerCase()]) {
          t = t.replace(De, "<$1></$2>");
          try {
    ...
    domManip: function(t, e) {
      ...
      var n, i, s, a, r, o, l = 0,
        ...
        h = t[0],
        g = K.isFunction(h);
      if (g || c > 1 && "string" == typeof h && !Z.checkClone && qe.test(h)) return this.each(function(n) {
        var i = d.eq(n);
      ...
      if (c && (n = K.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
        for (s = K.map(v(n, "script"), f), a = s.length; c > l; l++) r = n, l !== u && (r = K.clone(r, !0, !0), a && K.merge(s, v(r, "script"))), e.call(this[l], r, l);
        if (a)
          for (o = s[s.length - 1].ownerDocument, K.map(s, p), l = 0; a > l; l++) r = s[l], Ie.test(r.type || "") && !ve.access(r, "globalEval") && K.contains(o, r) && (r.src ? K._evalUrl && K._evalUrl(r.src) : K.globalEval(r.textContent.replace(Le, "")))
      }
      return this
    }
  }), K.each({
    ...
    K.fn[t] = function(t) {
      for (var n, i = [], s = K(t), a = s.length - 1, r = 0; a >= r; r++) n = r === a ? this : this.clone(!0), K(s[r])[e](n), U.apply(i, n.get());
  ...
  ! function() {
    function e() {
      r.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", r.innerHTML = "", s.appendChild(a);
      var e = t.getComputedStyle(r, null);
      n = "1%" !== e.top, i = "4px" === e.width, s.removeChild(a)
    }
    var n, i, s = G.documentElement,
      a = G.createElement("div"),
      r = G.createElement("div");
    r.style && (r.style.backgroundClip = "content-box", r.cloneNode(!0).style.backgroundClip = "", Z.clearCloneStyle = "content-box" === r.style.backgroundClip, a.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", a.appendChild(r), t.getComputedStyle && K.extend(Z, {
      ...
      reliableMarginRight: function() {
        var e, n = r.appendChild(G.createElement("div"));
        return n.style.cssText = r.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", n.style.marginRight = n.style.width = "0", r.style.width = "1px", s.appendChild(a), e = !parseFloat(t.getComputedStyle(n, null).marginRight), s.removeChild(a), e
      }
    }))
  ...
  K.extend({
    ...
    style: function(t, e, n, i) {
      if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
        var s, a, r, o = K.camelCase(e),
          l = t.style;
        return e = K.cssProps[o] || (K.cssProps[o] = F(l, o)), r = K.cssHooks[e] || K.cssHooks[o], void 0 === n ? r && "get" in r && void 0 !== (s = r.get(t, !1, i)) ? s : l[e] : (a = typeof n, "string" === a && (s = Ye.exec(n)) && (n = (s[1] + 1) * s[2] + parseFloat(K.css(t, e)), a = "number"), null != n && n === n && ("number" !== a || K.cssNumber[o] || (n += "px"), Z.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), r && "set" in r && void 0 === (n = r.set(t, n, i)) || (l[e] = n)), void 0)
      }
    },
    css: function(t, e, n, i) {
      var s, a, r, o = K.camelCase(e);
      return e = K.cssProps[o] || (K.cssProps[o] = F(t.style, o)), r = K.cssHooks[e] || K.cssHooks[o], r && "get" in r && (s = r.get(t, !0, n)), void 0 === s && (s = x(t, e, i)), "normal" === s && e in Qe && (s = Qe[e]), "" === n || n ? (a = parseFloat(s), n === !0 || K.isNumeric(a) ? a || 0 : s) : s
    }
  }), K.each(["height", "width"], function(t, e) {
    K.cssHooks[e] = {
      get: function(t, n, i) {
        return n ? We.test(K.css(t, "display")) && 0 === t.offsetWidth ? K.swap(t, Xe, function() {
          return A(t, e, i)
        }) : A(t, e, i) : void 0
      },
      set: function(t, n, i) {
        var s = i && Be(t);
        return C(t, n, i ? k(t, e, i, "border-box" === K.css(t, "boxSizing", !1, s), s) : 0)
      }
    }
    ...
    K.cssHooks[t + e] = {
      expand: function(n) {
        for (var i = 0, s = {}, a = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) s[t + we[i] + e] = a[i] || a[i - 2] || a[0];
        return s
      }
    }, ze.test(t) || (K.cssHooks[t + e].set = C)
  }), K.fn.extend({
    css: function(t, e) {
      return me(this, function(t, e, n) {
        var i, s, a = {},
          r = 0;
        if (K.isArray(e)) {
          for (i = Be(t), s = e.length; s > r; r++) a[e[r]] = K.css(t, e[r], !1, i);
          return a
        }
    ...
    init: function(t, e, n, i, s, a) {
      this.elem = t, this.prop = n, this.easing = s || "swing", this.options = e, this.start = this.now = this.cur(), this.end = i, this.unit = a || (K.cssNumber[n] ? "" : "px")
    },
    cur: function() {
    ...
    run: function(t) {
      ...
      return this.pos = e = this.options.duration ? K.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : $.propHooks._default.set(this), this
    }
    ...
    nn = {
      "*": [function(t, e) {
        var n = this.createTween(t, e),
          i = n.cur(),
          s = Ke.exec(e),
          a = s && s[3] || (K.cssNumber[t] ? "" : "px"),
          r = (K.cssNumber[t] || "px" !== a && +i) && Ke.exec(K.css(n.elem, t)),
          o = 1,
          l = 20;
        if (r && r[3] !== a) {
          a = a || r[3], s = s || [], r = +i || 1;
          do o = o || ".5", r /= o, K.style(n.elem, t, r + a); while (o !== (o = n.cur() / i) && 1 !== o && --l)
        }
        return s && (r = n.start = +r || +i || 0, n.unit = a, n.end = s[1] ? r + (s[1] + 1) * s[2] : +s[2]), n
      }]
    };
  K.Animation = K.extend(q, {
      ...
      finish: function(t) {
        return t !== !1 && (t = t || "fx"), this.each(function() {
          var e, n = ve.get(this),
            ...
            a = K.timers,
            r = i ? i.length : 0;
          for (n.finish = !0, K.queue(this, t, []), s && s.stop && s.stop.call(this, !0), e = a.length; e--;) a[e].elem === this && a[e].queue === t && (a[e].anim.stop(!0), a.splice(e, 1));
      ...
      var n = K.fn[e];
      K.fn[e] = function(t, i, s) {
        return null == t || "boolean" == typeof t ? n.apply(this, arguments) : this.animate(D(e, !0), t, i, s)
      }
    }), K.each({
      slideDown: D("show"),
      slideUp: D("hide"),
  ...
  var sn, an, rn = K.expr.attrHandle;
  K.fn.extend({
    attr: function(t, e) {
    ...
    removeAttr: function(t, e) {
      var n, i, s = 0,
        a = e && e.match(fe);
      if (a && 1 === t.nodeType)
        for (; n = a[s++];) i = K.propFix[n] || n, K.expr.match.bool.test(n) && (t[i] = !1), t.removeAttribute(n)
    },
    attrHooks: {
      type: {
        set: function(t, e) {
    ...
    var n = rn[e] || K.find.attr;
    rn[e] = function(t, e, i) {
      var s, a;
      return i || (a = rn[e], rn[e] = s, s = null != n(t, e, i) ? e.toLowerCase() : null, rn[e] = a), s
    }
  });
  ...
  K.fn.extend({
    ...
    prop: function(t, e, n) {
      var i, s, a, r = t.nodeType;
      return t && 3 !== r && 8 !== r && 2 !== r ? (a = 1 !== r || !K.isXMLDoc(t), a && (e = K.propFix[e] || e, s = K.propHooks[e]), void 0 !== n ? s && "set" in s && void 0 !== (i = s.set(t, n, e)) ? i : t[e] = n : s && "get" in s && null !== (i = s.get(t, e)) ? i : t[e]) : void 0
    },
    propHooks: {
      tabIndex: {
        get: function(t) {
          return t.hasAttribute("tabindex") || on.test(t.nodeName) || t.href ? t.tabIndex : -1
        }
      }
    }
  ...
  K.fn.extend({
    addClass: function(t) {
      var e, n, i, s, a, r, o = "string" == typeof t && t,
        l = 0,
        c = this.length;
    ...
    removeClass: function(t) {
      var e, n, i, s, a, r, o = 0 === arguments.length || "string" == typeof t && t,
        l = 0,
        c = this.length;
      if (K.isFunction(t)) return this.each(function(e) {
    ...
    toggleClass: function(t, e) {
      ...
      return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(K.isFunction(t) ? function(n) {
        ...
        if ("string" === n)
          for (var e, i = 0, s = K(this), a = t.match(fe) || []; e = a[i++];) s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
        else(n === ke || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || t === !1 ? "" : ve.get(this, "__className__") || "")
      })
    },
    hasClass: function(t) {
  ...
  K.fn.extend({
    val: function(t) {
      ...
      return arguments.length ? (i = K.isFunction(t), this.each(function(n) {
        var s;
        1 === this.nodeType && (s = i ? t.call(this, n, K(this).val()) : t, null == s ? s = "" : "number" == typeof s ? s += "" : K.isArray(s) && (s = K.map(s, function(t) {
          return null == t ? "" : t + ""
        })), e = K.valHooks[this.type] || K.valHooks[this.nodeName.toLowerCase()], e && "set" in e && void 0 !== e.set(this, s, "value") || (this.value = s))
      })) : s ? (e = K.valHooks[s.type] || K.valHooks[s.nodeName.toLowerCase()], e && "get" in e && void 0 !== (n = e.get(s, "value")) ? n : (n = s.value, "string" == typeof n ? n.replace(cn, "") : null == n ? "" : n)) : void 0
    }
  }), K.extend({
    valHooks: {
      option: {
      ...
      select: {
        get: function(t) {
          for (var e, n, i = t.options, s = t.selectedIndex, a = "select-one" === t.type || 0 > s, r = a ? null : [], o = a ? s + 1 : i.length, l = 0 > s ? o : a ? s : 0; o > l; l++)
            if (n = i[l], !(!n.selected && l !== s || (Z.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && K.nodeName(n.parentNode, "optgroup"))) {
        ...
        set: function(t, e) {
          for (var n, i, s = t.options, a = K.makeArray(e), r = s.length; r--;) i = s[r], (i.selected = K.inArray(i.value, a) >= 0) && (n = !0);
  ...
  hn = bn.exec(fn.toLowerCase()) || [], K.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ajaxSettings: {
    ...
    ajax: function(t, e) {
      function n(t, e, n, r) {
        var l, d, v, _, b, w = e;
        2 !== y && (y = 2, o && clearTimeout(o), i = void 0, a = r || "", x.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (_ = H(u, x, n)), _ = O(u, _, x, l), l ? (u.ifModified && (b = x.getResponseHeader("Last-Modified"), b && (K.lastModified[s] = b), b = x.getResponseHeader("etag"), b && (K.etag[s] = b)), 204 === t || "HEAD" === u.type ? w = "nocontent" : 304 === t ? w = "notmodified" : (w = _.state, d = _.data, v = _.error, l = !v)) : (v = w, (t || !w) && (w = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (e || w) + "", l ? p.resolveWith(h, [d, w, x]) : p.rejectWith(h, [x, w, v]), x.statusCode(m), m = void 0, c && f.trigger(l ? "ajaxSuccess" : "ajaxError", [x, u, l ? d : v]), g.fireWith(h, [x, w]), c && (f.trigger("ajaxComplete", [x, u]), --K.active || K.event.trigger("ajaxStop")))
      }
      "object" == typeof t && (e = t, t = void 0), e = e || {};
      var i, s, a, r, o, l, c, d, u = K.ajaxSetup({}, e),
        h = u.context || u,
        f = u.context && (h.nodeType || h.jquery) ? K(h) : K.event,
        p = K.Deferred(),
        ...
        x = {
          ...
          getResponseHeader: function(t) {
            ...
            if (2 === y) {
              if (!r)
                for (r = {}; e = mn.exec(a);) r[e[1].toLowerCase()] = e[2];
              e = r[t.toLowerCase()]
            }
      ...
      if (p.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, u.url = ((t || u.url || fn) + "").replace(pn, "").replace(yn, hn[1] + "//"), u.type = e.method || e.type || u.method || u.type, u.dataTypes = K.trim(u.dataType || "*").toLowerCase().match(fe) || [""], null == u.crossDomain && (l = bn.exec(u.url.toLowerCase()), u.crossDomain = !(!l || l[1] === hn[1] && l[2] === hn[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (hn[3] || ("http:" === hn[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = K.param(u.data, u.traditional)), N(xn, u, e, x), 2 === y) return x;
      c = u.global, c && 0 === K.active++ && K.event.trigger("ajaxStart"), u.type = u.type.toUpperCase(), u.hasContent = !_n.test(u.type), s = u.url, u.hasContent || (u.data && (s = u.url += (un.test(s) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (u.url = gn.test(s) ? s.replace(gn, "$1_=" + dn++) : s + (un.test(s) ? "&" : "?") + "_=" + dn++)), u.ifModified && (K.lastModified[s] && x.setRequestHeader("If-Modified-Since", K.lastModified[s]), K.etag[s] && x.setRequestHeader("If-None-Match", K.etag[s])), (u.data && u.hasContent && u.contentType !== !1 || e.contentType) && x.setRequestHeader("Content-Type", u.contentType), x.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + Fn + "; q=0.01" : "") : u.accepts["*"]);
      ...
      if (i = N(wn, u, e, x)) {
        x.readyState = 1, c && f.trigger("ajaxSend", [x, u]), u.async && u.timeout > 0 && (o = setTimeout(function() {
          x.abort("timeout")
        }, u.timeout));
        try {
          y = 1, i.send(v, n)
    ...
    K[e] = function(t, n, i, s) {
      return K.isFunction(n) && (s = s || i, i = n, n = void 0), K.ajax({
        url: t,
        type: e,
        dataType: s,
        data: n,
  ...
  K.param = function(t, e) {
    ...
    serializeArray: function() {
      return this.map(function() {
        ...
        var t = this.type;
        return this.name && !K(this).is(":disabled") && Tn.test(this.nodeName) && !$n.test(t) && (this.checked || !Ce.test(t))
      }).map(function(t, e) {
        var n = K(this).val();
  ...
  var Dn = 0,
    ...
    Mn = K.ajaxSettings.xhr();
  t.ActiveXObject && K(t).on("unload", function() {
    for (var t in En) En[t]()
  }), Z.cors = !!Mn && "withCredentials" in Mn, Z.ajax = Mn = !!Mn, K.ajaxTransport(function(t) {
    var e;
    return Z.cors || Mn && !t.crossDomain ? {
      send: function(n, i) {
        ...
        e = function(t) {
          return function() {
            e && (delete En[r], e = a.onload = a.onerror = null, "abort" === t ? a.abort() : "error" === t ? i(a.status, a.statusText) : i(jn[a.status] || a.status, a.statusText, "string" == typeof a.responseText ? {
              text: a.responseText
            } : void 0, a.getAllResponseHeaders()))
          }
        }, a.onload = e(), a.onerror = e("error"), e = En[r] = e("abort");
        try {
  ...
  K.ajaxSetup({
    ...
    jsonpCallback: function() {
      var t = qn.pop() || K.expando + "_" + dn++;
      return this[t] = !0, t
    }
  }), K.ajaxPrefilter("json jsonp", function(e, n, i) {
    var s, a, r, o = e.jsonp !== !1 && (In.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && In.test(e.data) && "data");
    return o || "jsonp" === e.dataTypes[0] ? (s = e.jsonpCallback = K.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, o ? e[o] = e[o].replace(In, "$1" + s) : e.jsonp !== !1 && (e.url += (un.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function() {
      return r || K.error(s + " was not called"), r[0]
    }, e.dataTypes[0] = "json", a = t[s], t[s] = function() {
      r = arguments
    }, i.always(function() {
      t[s] = a, e[s] && (e.jsonpCallback = n.jsonpCallback, qn.push(s)), r && K.isFunction(a) && a(r[0]), r = a = void 0
    }), "script") : void 0
    ...
    var i = re.exec(t),
      s = !n && [];
    return i ? [e.createElement(i[1])] : (i = K.buildFragment([t], e, s), s && s.length && K(s).remove(), K.merge([], i.childNodes))
  };
  var Nn = K.fn.load;
  K.fn.load = function(t, e, n) {
    ...
    var i, s, a, r = this,
      o = t.indexOf(" ");
    return o >= 0 && (i = K.trim(t.slice(o)), t = t.slice(0, o)), K.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (s = "POST"), r.length > 0 && K.ajax({
      url: t,
      type: s,
      dataType: "html",
      data: e
    }).done(function(t) {
      a = arguments, r.html(i ? K("<div>").append(K.parseHTML(t)).find(i) : t)
  ...
  K.offset = {
    setOffset: function(t, e, n) {
      var i, s, a, r, o, l, c, d = K.css(t, "position"),
        u = K(t),
        h = {};
      "static" === d && (t.style.position = "relative"), o = u.offset(), a = K.css(t, "top"), l = K.css(t, "left"), c = ("absolute" === d || "fixed" === d) && (a + l).indexOf("auto") > -1, c ? (i = u.position(), r = i.top, s = i.left) : (r = parseFloat(a) || 0, s = parseFloat(l) || 0), K.isFunction(e) && (e = e.call(t, n, o)), null != e.top && (h.top = e.top - o.top + r), null != e.left && (h.left = e.left - o.left + s), "using" in e ? e.using.call(t, h) : u.css(h)
    }
  }, K.fn.extend({
    offset: function(t) {
      ...
      var e, n, i = this[0],
        ...
        a = i && i.ownerDocument;
      return a ? (e = a.documentElement, K.contains(e, i) ? (typeof i.getBoundingClientRect !== ke && (s = i.getBoundingClientRect()), n = z(a), {
    ...
    var i = "pageYOffset" === n;
    K.fn[e] = function(s) {
      return me(this, function(e, s, a) {
        var r = z(e);
        return void 0 === a ? r ? r[n] : e[s] : void(r ? r.scrollTo(i ? t.pageXOffset : a, i ? a : t.pageYOffset) : e[s] = a)
      }, e, s, arguments.length, null)
    }
  }), K.each(["top", "left"], function(t, e) {
    K.cssHooks[e] = w(Z.pixelPosition, function(t, n) {
      return n ? (n = x(t, e), Re.test(n) ? K(t).position()[e] + "px" : n) : void 0
    })
  }), K.each({
    Height: "height",
    Width: "width"
    ...
    K.each({
      ...
      K.fn[i] = function(i, s) {
        ...
        return me(this, function(e, n, i) {
          var s;
          return K.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (s = e.documentElement, Math.max(e.body["scroll" + t], s["scroll" + t], e.body["offset" + t], s["offset" + t], s["client" + t])) : void 0 === i ? K.css(e, n, r) : K.style(e, n, i, r)
        }, e, a ? i : void 0, a, null)
      }
    })
  }), K.fn.size = function() {
  ...
  return K.noConflict = function(e) {
    return t.$ === K && (t.$ = On), e && t.jQuery === K && (t.jQuery = Hn), K
  ...
  t.extend(t.fn, {
    ...
    rules: function(e, n) {
      ...
      if (e) {
        ...
        switch (e) {
          case "add":
            t.extend(r, t.validator.normalizeRule(n)), delete r.messages, a[i.name] = r, n.messages && (s.messages[i.name] = t.extend(s.messages[i.name], n.messages));
            break;
          case "remove":
    ...
    prototype: {
      ...
      check: function(e) {
        ...
        for (var r in i) {
          ...
          try {
            if (n = t.validator.methods[r].call(this, a, e, o.parameters), "dependency-mismatch" === n) {
              s = !0;
              continue
            }
            if (s = !1, "pending" === n) return this.toHide = this.toHide.not(this.errorsFor(e)), void 0;
    ...
    dataRules: function(e) {
      var n, i, s = {},
        a = t(e);
      for (n in t.validator.methods) i = a.data("rule-" + n.toLowerCase()), void 0 !== i && (s[n] = i);
      return s
    },
    ...
    normalizeRules: function(e, n) {
      return t.each(e, function(i, s) {
        if (s === !1) return delete e[i], void 0;
        ...
        return r[n.name] = e, t.ajax(t.extend(!0, {
          ...
          success: function(i) {
            ...
            if (r) {
              ...
              l[n.name] = s.message = t.isFunction(c) ? c(e) : c, a.invalid[n.name] = !0, a.showErrors(l)
            }
...
function(t) {
  ...
  if (t.ajaxPrefilter) t.ajaxPrefilter(function(t, n, i) {
    ...
    t.ajax = function(i) {
      ...
      return "abort" === s ? (e[a] && e[a].abort(), e[a] = n.apply(this, arguments), e[a]) : n.apply(this, arguments)
    }
  }
}(jQuery),
function(t) {
  ...
  }, t.fn.waitForImages = function(n, i, s) {
    var a = 0,
      r = 0;
    if (t.isPlainObject(arguments[0]) && (s = arguments[0].waitForAll, i = arguments[0].each, n = arguments[0].finished), n = n || t.noop, i = i || t.noop, s = !!s, !t.isFunction(n) || !t.isFunction(i)) throw new TypeError("An invalid callback was supplied.");
    return this.each(function() {
      var o = t(this),
        l = [],
        c = t.waitForImages.hasImageProperties || [],
        d = /url\(\s*(['"]?)(.*?)\1\s*\)/g;
      s ? o.find("*").addBack().each(function() {
        var e = t(this);
  ...
  t.fn.prettyEmbed = function(n) {
    ...
    r = 0 === t(this).length ? t(".pretty-embed") : t(this), r.each(function() {
      ...
      if (p = t(this).attr("data-pe-videoid") !== e ? t(this).attr("data-pe-videoid") : t(this).attr("href") !== e ? s(t(this).attr("href")) : n.videoID, g = t(this).attr("data-pe-preview-size") !== e ? t(this).attr("data-pe-preview-size") : n.previewSize !== e ? n.previewSize : e, m = t(this).attr("data-pe-custom-preview-image") !== e ? t(this).attr("data-pe-custom-preview-image") : n.customPreviewImage !== e ? n.customPreviewImage : e, r = t(this).attr("data-pe-show-info") !== e ? t(this).attr("data-pe-show-info") : n.showInfo !== e ? n.showInfo : e, o = t(this).attr("data-pe-show-controls") !== e ? t(this).attr("data-pe-show-controls") : n.showControls !== e ? n.showControls : e, l = t(this).attr("data-pe-loop") !== e ? t(this).attr("data-pe-loop") : n.loop !== e ? n.loop : e, c = t(this).attr("data-pe-closed-captions") !== e ? t(this).attr("data-pe-closed-captions") : n.closedCaptions !== e ? n.closedCaptions : e, d = t(this).attr("data-pe-localization") !== e ? t(this).attr("data-pe-localization") : n.localization !== e ? n.localization : e, u = t(this).attr("data-pe-color-scheme") !== e ? t(this).attr("data-pe-color-scheme") : n.colorScheme !== e ? n.colorScheme : e, h = t(this).attr("data-pe-show-related") !== e ? t(this).attr("data-pe-show-related") : n.showRelated !== e ? n.showRelated : e, f = t(this).attr("data-pe-allow-fullscreen") !== e ? t(this).attr("data-pe-allow-fullscreen") : n.allowFullScreen !== e ? n.allowFullScreen : e, t(this).is("a") && (i = t("<div />").addClass("pretty-embed"), i.attr("data-pe-videoid", p).attr("data-pe-preview-size", g).attr("data-pe-custom-preview-image", m).attr("data-pe-show-info", r).attr("data-pe-show-controls", o).attr("data-pe-loop", l).attr("data-pe-closed-captions", c).attr("data-pe-localization", d).attr("data-pe-color-scheme", u).attr("data-pe-show-related", h).attr("data-pe-allow-fullscreen", f), t(this).after(i)), m !== e && "" !== m) t(this).html('<img src="' + m + '" width="100%" alt="YouTube Video Preview" />');
        ...
        t(this).html('<img src="//img.youtube.com/vi/' + p + "/" + v + '.jpg" width="100%" alt="YouTube Video Preview" />')
      }
      t(this).is("a") && (i.html(t(this).html()), t(this).remove()), a && t(window).on("load", function() {
        t(".pretty-embed")
      })
    }), t("body").on("click", ".pretty-embed", function(e) {
      e.preventDefault(), i(t(this))
    }), t.fn.prettyEmbed.options = {
      videoID: "",
      previewSize: "",
      customPreviewImage: "",
      showInfo: !0,
  ...
  t.MixItUp = function() {
    ...
    addAction: function(e, n, i, s) {
      t.MixItUp.prototype._addHook("_actions", e, n, i, s)
    },
    addFilter: function(e, n, i, s) {
      t.MixItUp.prototype._addHook("_filters", e, n, i, s)
    },
    _addHook: function(e, n, i, s, a) {
      var r = t.MixItUp.prototype[e],
        o = {};
      a = 1 === a || "post" === a ? "post" : "pre", o[n] = {}, o[n][a] = {}, o[n][a][i] = s, t.extend(!0, r, o)
    },
    _init: function(e, n) {
      var i = this;
      if (i._execAction("_init", 0, arguments), n && t.extend(!0, i, n), i._$body = t("body"), i._domNode = e, i._$container = t(e), i._$container.addClass(i.layout.containerClass), i._id = e.id, i._platformDetect(), i._brake = i._getPrefixedCSS("transition", "none"), i._refresh(!0), i._$parent = i._$targets.parent().length ? i._$targets.parent() : i._$container, i.load.sort && (i._newSort = i._parseSort(i.load.sort), i._newSortString = i.load.sort, i._activeSort = i.load.sort, i._sort(), i._printSort()), i._activeFilter = "all" === i.load.filter ? i.selectors.target : "none" === i.load.filter ? "" : i.load.filter, i.controls.enable && i._bindHandlers(), i.controls.toggleFilterButtons) {
        i._buildToggleArray();
        for (var s = 0; s < i._toggleArray.length; s++) i._updateControls({
          filter: i._toggleArray[s],
          sort: i._activeSort
        }, !0)
    ...
    _platformDetect: function() {
      var t = this,
        ...
        o = r(t._domNode);
      t._execAction("_platformDetect", 0), t._chrome = s ? parseInt(s[1], 10) : !1, t._ff = a ? parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1]) : !1, t._prefix = o.prefix, t._vendor = o.vendor, t._suckMode = window.atob && t._prefix ? !1 : !0, t._suckMode && (t.animation.enable = !1), t._ff && t._ff <= 4 && (t.animation.enable = !1);
    ...
    _bindHandlers: function() {
      ...
      n._execAction("_bindHandlers", 0), n.controls.live ? n._$body.on("click.mixItUp." + n._id, n.selectors.sort, function() {
        ...
        n._processClick(t(this), "filter")
      })), i[n.selectors.filter] = i[n.selectors.filter] === e ? 1 : i[n.selectors.filter] + 1, s[n.selectors.sort] = s[n.selectors.sort] === e ? 1 : s[n.selectors.sort] + 1, n._execAction("_bindHandlers", 1)
    },
    _processClick: function(n, i) {
      var s = this,
        a = function(n, i, a) {
          var r = t.MixItUp.prototype;
          r._handled["_" + i][s.selectors[i]] = r._handled["_" + i][s.selectors[i]] === e ? 1 : r._handled["_" + i][s.selectors[i]] + 1, r._handled["_" + i][s.selectors[i]] === r._bound["_" + i][s.selectors[i]] && (n[(a ? "remove" : "add") + "Class"](s.controls.activeClass), delete r._handled["_" + i][s.selectors[i]])
        };
      if (s._execAction("_processClick", 0, arguments), !s._mixing || s.animation.queue && s._queue.length < s.animation.queueLimit) {
        if (s._clicking = !0, "sort" === i) {
          var r = n.attr("data-sort");
          (!n.hasClass(s.controls.activeClass) || r.indexOf("random") > -1) && (t(s.selectors.sort).removeClass(s.controls.activeClass), a(n, i), s.sort(r))
        }
        if ("filter" === i) {
          var o, l = n.attr("data-filter"),
            c = "or" === s.controls.toggleLogic ? "," : "";
          s.controls.toggleFilterButtons ? (s._buildToggleArray(), n.hasClass(s.controls.activeClass) ? (a(n, i, !0), o = s._toggleArray.indexOf(l), s._toggleArray.splice(o, 1)) : (a(n, i), s._toggleArray.push(l)), s._toggleArray = t.grep(s._toggleArray, function(t) {
            return t
          }), s._toggleString = s._toggleArray.join(c), s.filter(s._toggleString)) : n.hasClass(s.controls.activeClass) || (t(s.selectors.filter).removeClass(s.controls.activeClass), a(n, i), s.filter(l))
        }
    ...
    _updateControls: function(n, i) {
      var s = this,
        ...
        r = function(t, e) {
          i && "filter" == o && "none" !== a.filter && "" !== a.filter ? t.filter(e).addClass(s.controls.activeClass) : t.removeClass(s.controls.activeClass).filter(e).addClass(s.controls.activeClass)
        },
        o = "filter",
        l = null;
      s._execAction("_updateControls", 0, arguments), n.filter === e && (a.filter = s._activeFilter), n.sort === e && (a.sort = s._activeSort), a.filter === s.selectors.target && (a.filter = "all");
      for (var c = 0; 2 > c; c++) l = s.controls.live ? t(s.selectors[o]) : s["_$" + o + "Buttons"], l && r(l, "[data-" + o + '="' + a[o] + '"]'), o = "sort";
    ...
    _compare: function(t, e, n) {
      n = n ? n : 0;
      var i = this,
        s = i._newSort[n].order,
        a = function(t) {
          return t.dataset[i._newSort[n].sortBy] || 0
        },
        r = isNaN(1 * a(t)) ? a(t).toLowerCase() : 1 * a(t),
        o = isNaN(1 * a(e)) ? a(e).toLowerCase() : 1 * a(e);
      return o > r ? "asc" == s ? -1 : 1 : r > o ? "asc" == s ? 1 : -1 : r == o && i._newSort.length > n + 1 ? i._compare(t, e, n + 1) : 0
    },
    _printSort: function(t) {
      var e = this,
        n = t ? e._startOrder : e._newOrder,
        i = e._$parent[0].querySelectorAll(e.selectors.target),
        s = i[i.length - 1].nextElementSibling,
        a = document.createDocumentFragment();
      e._execAction("_printSort", 0, arguments);
      for (var r = 0; r < i.length; r++) {
        var o = i[r],
          l = o.nextSibling;
        "absolute" !== o.style.position && (l && "#text" == l.nodeName && e._$parent[0].removeChild(l), e._$parent[0].removeChild(o))
      }
      for (var r = 0; r < n.length; r++) {
        ...
        if ("default" != e._newSort[0].sortBy || "desc" != e._newSort[0].order || t) a.appendChild(c), a.appendChild(document.createTextNode(" "));
          ...
          var d = a.firstChild;
          a.insertBefore(c, d), a.insertBefore(document.createTextNode(" "), c)
        }
      }
      s ? e._$parent[0].insertBefore(a, s) : e._$parent[0].appendChild(a), e._execAction("_printSort", 1, arguments)
    },
    _parseSort: function(t) {
      for (var e = this, n = "string" == typeof t ? t.split(" ") : [t], i = [], s = 0; s < n.length; s++) {
        var a = "string" == typeof t ? n[s].split(":") : ["custom", n[s]],
          r = {
        ...
        n = function(e, n) {
          if (t.animation.effects.indexOf(e) > -1) {
            if (n) {
              ...
              if (i > -1) {
                var s = t.animation.effects.substring(i),
                  a = /\(([^)]+)\)/.exec(s),
                  r = a[1];
                return {
                  val: r
    ...
    _buildState: function(t) {
      ...
      }, t ? e._execFilter("_buildState", n) : (e._state = n, e._execAction("_buildState", 1), void 0)
    },
    _goMix: function(t) {
      var e = this,
        n = function() {
        ...
        i = function() {
          ...
          document.documentElement.scrollHeight, e._getInterMixData(), e._setFinal(), e._getFinalMixData(), window.pageYOffset !== t && window.scrollTo(n, t), e._prepTargets(), window.requestAnimationFrame ? requestAnimationFrame(s) : setTimeout(function() {
            s()
          }, 20)
        },
        s = function() {
    ...
    _prepTargets: function() {
      ...
      for (var i = 0; i < e._$toShow.length; i++) {
        var s = e._$toShow[i],
          a = t(s);
        s.style.opacity = e.effects.opacity, s.style.display = e._changingLayout && e.animation.animateChangeLayout ? e._newDisplay : e.layout.display, a.css(n._in), e.animation.animateResizeTargets && (s.style.width = s.dataset.finalWidth + "px", s.style.height = s.dataset.finalHeight + "px", s.style.marginRight = -(s.dataset.finalWidth - s.dataset.interWidth) + 1 * s.dataset.finalMarginRight + "px", s.style.marginBottom = -(s.dataset.finalHeight - s.dataset.interHeight) + 1 * s.dataset.finalMarginBottom + "px")
      }
    ...
    _animateTargets: function() {
      ...
      for (var n = 0; n < e._$toShow.length; n++) {
        ...
        for (var l = 0; 2 > l; l++) {
          ...
          e._ff && e._ff <= 20 && (o[c + "transition-property"] = "all", o[c + "transition-timing-function"] = e.animation.easing + "ms", o[c + "transition-duration"] = e.animation.duration + "ms"), o[c + "transition-delay"] = r + "ms", o[c + "transform"] = "translate(" + a.x + "px," + a.y + "px)"
        }(e.effects.transform || e.effects.opacity) && e._bindTargetDone(s), e._ff && e._ff <= 20 ? s.css(o) : s.css(e.effects.transition).css(o)
      }
      ...
      for (var n = 0; n < e._$toHide.length; n++) {
        for (var i = e._$toHide[n], s = t(i), r = e._getDelay(n), d = {}, l = 0; 2 > l; l++) {
          var c = 0 === l ? c = e._prefix : "";
          d[c + "transition-delay"] = r + "ms", d[c + "transform"] = e.effects.transformOut, d.opacity = e.effects.opacity
        }
        s.css(e.effects.transition).css(d), (e.effects.transform || e.effects.opacity) && e._bindTargetDone(s)
      }
    ...
    _bindTargetDone: function(e) {
      var n = this,
        i = e[0];
      n._execAction("_bindTargetDone", 0, arguments), i.dataset.bound || (i.dataset.bound = !0, n._targetsBound++, e.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function(s) {
        (s.originalEvent.propertyName.indexOf("transform") > -1 || s.originalEvent.propertyName.indexOf("opacity") > -1) && t(s.originalEvent.target).is(n.selectors.target) && (e.off(".mixItUp"), delete i.dataset.bound, n._targetDone())
    ...
    _getPrefixedCSS: function(t, e, n) {
      ...
      return s._execFilter("_getPrefixedCSS", a, arguments)
    },
    ...
    _parseMultiMixArgs: function(t) {
      for (var e = this, n = {
        ...
        var s = t[i];
        null !== s && ("object" == typeof s || "string" == typeof s ? n.command = s : "boolean" == typeof s ? n.animate = s : "function" == typeof s && (n.callback = s))
      }
    ...
    _execAction: function(t, e, n) {
      ...
      if (!i._actions.isEmptyObject && i._actions.hasOwnProperty(t))
        for (var a in i._actions[t][s]) i._actions[t][s][a].call(i, n)
    },
    _execFilter: function(t, e, n) {
      var i = this;
      if (i._filters.isEmptyObject || !i._filters.hasOwnProperty(t)) return e;
      for (var s in i._filters[t]) return i._filters[t][s].call(i, n)
    },
    _helpers: {
    ...
    multiMix: function() {
      ...
      if (t._execAction("multiMix", 0, arguments), t._mixing) t.animation.queue && t._queue.length < t.animation.queueLimit ? (t._queue.push(arguments), t.controls.enable && !t._clicking && t._updateControls(n.command), t._execAction("multiMixQueue", 1, arguments)) : ("function" == typeof t.callbacks.onMixBusy && t.callbacks.onMixBusy.call(t._domNode, t._state, t), t._$container.trigger("mixBusy", [t._state, t]), t._execAction("multiMixBusy", 1, arguments));
        ...
        t._refresh(), i && (t._newSort = t._parseSort(i), t._newSortString = i, t._sorting = !0, t._sort()), s !== e && (s = "all" === s ? t.selectors.target : s, t._activeFilter = s), t._filter(), a && (t._newDisplay = "string" == typeof a ? a : a.display || t.layout.display, t._newClass = a.containerClass || "", (t._newDisplay !== t.layout.display || t._newClass !== t.layout.containerClass) && (t._changingLayout = !0, t._changingClass = t._newClass !== t.layout.containerClass, t._changingDisplay = t._newDisplay !== t.layout.display)), t._$targets.css(t._brake), t._goMix(n.animate ^ t.animation.enable ? n.animate : t.animation.enable), t._execAction("multiMix", 1, arguments)
      }
    },
    insert: function() {
      var t = this,
    ...
    getOption: function(t) {
      var n = this,
        i = function(t, n) {
          for (var i = n.split("."), s = i.pop(), a = i.length, r = 1, o = i[0] || n;
            (t = t[o]) && a > r;) o = i[r], r++;
    ...
    var n, i = arguments,
      ...
      a = function(e, n) {
        ...
        i._execAction("_instantiate", 0, arguments), e.id = e.id ? e.id : "MixItUp" + s(), i._instances[e.id] || (i._instances[e.id] = i, i._init(e, n)), i._execAction("_instantiate", 1, arguments)
      };
    return n = this.each(function() {
      if (i && "string" == typeof i[0]) {
        var n = t.MixItUp.prototype._instances[this.id];
        if ("isLoaded" == i[0]) s.push(n ? !0 : !1);
        else {
          var r = n[i[0]](i[1], i[2], i[3]);
          r !== e && s.push(r)
        }
      } else a(this, i[0])
    }), s.length ? s.length > 1 ? s : s[0] : n
  }, t.fn.removeStyle = function(t, n) {
    return n = n ? n : "", this.each(function() {
      for (var i = this, s = t.split(" "), a = 0; a < s.length; a++)
        for (var r = 0; 2 > r; r++) {
          var o = r ? s[a] : n + s[a];
          if (i.style[o] !== e && "unknown" != typeof i.style[o] && i.style[o].length > 0 && (i.style[o] = ""), !n) break
        }
...
function(t) {
  function e() {
    ...
    for (var e = 0; e < i.length; e++) {
      var s = t(i[e]).filter(function() {
        return t(this).is(":appeared")
      });
      if (s.trigger("appear", [s]), n) {
        var r = n.not(s);
  ...
  t.expr[":"].appeared = function(e) {
    ...
    var i = o.scrollLeft(),
      ...
      r = a.left,
      l = a.top;
    return l + n.height() >= s && l - (n.data("appear-top-offset") || 0) <= s + o.height() && r + n.width() >= i && r - (n.data("appear-left-offset") || 0) <= i + o.width() ? !0 : !1
  }, t.fn.extend({
    appear: function(n) {
      var o = t.extend({}, r, n || {}),
      ...
      if (!s) {
        var c = function() {
          a || (a = !0, setTimeout(e, o.interval))
        };
        t(window).scroll(c).resize(c), s = !0
      }
      return o.force_process && setTimeout(e, o.interval), i.push(l), t(l)
    }
  }), t.extend({
...
FastClick.prototype.needsClick = function(t) {
    ...
    "use strict";
    var e, n, i, s, a, r = this.targetElement;
    if (!this.trackingClick) return !0;
    if (t.timeStamp - this.lastClickTime < this.tapDelay) return this.cancelNextClick = !0, !0;
    if (this.cancelNextClick = !1, this.lastClickTime = t.timeStamp, n = this.trackingClickStart, this.trackingClick = !1, this.trackingClickStart = 0, deviceIsIOSWithBadTarget && (a = t.changedTouches[0], r = document.elementFromPoint(a.pageX - window.pageXOffset, a.pageY - window.pageYOffset) || r, r.fastClickScrollParent = this.targetElement.fastClickScrollParent), i = r.tagName.toLowerCase(), "label" === i) {
    ...
    return deviceIsIOS && !deviceIsIOS4 && (s = r.fastClickScrollParent, s && s.fastClickLastScrollTop !== s.scrollTop) ? !0 : (this.needsClick(r) || (t.preventDefault(), this.sendClick(r, t)), !1)
  ...
  function(t, e, n, i) {
    ...
    var r = function(e, i) {
      ...
      c = function(e, n) {
        var i = this,
          s = !r(this).data(this.attr_name(!0));
        return r(this.scope).is("[" + this.attr_name() + "]") ? (r(this.scope).data(this.attr_name(!0) + "-init", t.extend({}, this.settings, n || e, this.data_options(r(this.scope)))), s && this.events(this.scope)) : r("[" + this.attr_name() + "]", this.scope).each(function() {
          var s = !r(this).data(i.attr_name(!0) + "-init");
          r(this).data(i.attr_name(!0) + "-init", t.extend({}, i.settings, n || e, i.data_options(r(this)))), s && i.events(this)
    ...
    e.matchMedia = e.matchMedia || function(t) {
      ...
      function() {
        function t() {
          n && (a(t), o && jQuery.fx.tick())
        }
        for (var n, i = 0, s = ["webkit", "moz"], a = e.requestAnimationFrame, r = e.cancelAnimationFrame, o = "undefined" != typeof jQuery.fx; i < s.length && !a; i++) a = e[s[i] + "RequestAnimationFrame"], r = r || e[s[i] + "CancelAnimationFrame"] || e[s[i] + "CancelRequestAnimationFrame"];
        a ? (e.requestAnimationFrame = a, e.cancelAnimationFrame = r, o && (jQuery.fx.timer = function(e) {
        ...
        init: function(t, e, n, i, s) {
          var a = [t, n, i, s],
            o = [];
          if (this.rtl = /rtl/i.test(r("html").attr("dir")), this.scope = t || this.scope, this.set_namespace(), e && "string" == typeof e && !/reflow/i.test(e)) this.libs.hasOwnProperty(e) && o.push(this.init_lib(e, a));
          else
            for (var l in this.libs) o.push(this.init_lib(l, e));
          return t
        },
        ...
        patch: function(t) {
          t.scope = this.scope, t.namespace = this.global.namespace, t.rtl = this.rtl, t.data_options = this.utils.data_options, t.attr_name = o, t.add_namespace = l, t.bindings = c, t.S = this.utils.S
        },
        ...
        utils: {
          ...
          debounce: function(t, e, n) {
            ...
            return function() {
              var a = this,
                ...
                l = n && !i;
              return clearTimeout(i), i = setTimeout(o, e), l && (s = t.apply(a, r)), s
            }
          },
          data_options: function(e, n) {
            ...
            for (o = (d || ":").split(";"), a = o.length; a--;) r = o[a].split(":"), r = [r[0], r.slice(1).join(":")], /true/i.test(r[1]) && (r[1] = !0), /false/i.test(r[1]) && (r[1] = !1), i(r[1]) && (r[1] = -1 === r[1].indexOf(".") ? parseInt(r[1], 10) : parseFloat(r[1])), 2 === r.length && r[0].length > 0 && (l[s(r[0])] = s(r[1]));
            return l
          },
    ...
    Foundation.libs.slider = {
        ...
        t(this.scope).off(".slider").on("mousedown.fndtn.slider touchstart.fndtn.slider pointerdown.fndtn.slider", "[" + n.attr_name() + "]:not(.disabled, [disabled]) .range-slider-handle", function(e) {
          ...
          if (n.cache.active)
            if (i.preventDefault(), t.data(n.cache.active[0], "settings").vertical) {
              var s = 0;
              i.pageY || (s = e.scrollY), n.calculate_position(n.cache.active, (i.pageY || i.originalEvent.clientY || i.originalEvent.touches[0].clientY || i.currentPoint.y) + s)
            } else n.calculate_position(n.cache.active, i.pageX || i.originalEvent.clientX || i.originalEvent.touches[0].clientX || i.currentPoint.x)
      ...
      calculate_position: function(e, n) {
        ...
        requestAnimationFrame(function() {
          var t;
          t = Foundation.rtl && !s.vertical ? i.limit_to((r + a - n) / a, 0, 1) : i.limit_to((n - r) / a, 0, 1), t = s.vertical ? 1 - t : t;
          var o = i.normalized_value(t, s.start, s.end, s.step);
          i.set_ui(e, o)
        })
      },
      set_ui: function(e, n) {
    ...
    Foundation.libs.joyride = {
      ...
      start: function() {
        ...
        !n.length > 0 || (this.settings.init || this.events(), this.settings = n.data(this.attr_name(!0) + "-init"), this.settings.$content_el = n, this.settings.$body = t(this.settings.tip_container), this.settings.body_offset = t(this.settings.tip_container).position(), this.settings.$tip_content = this.settings.$content_el.find("> li"), this.settings.paused = !1, this.settings.attempts = 0, "function" != typeof t.cookie && (this.settings.cookie_monster = !1), (!this.settings.cookie_monster || this.settings.cookie_monster && !t.cookie(this.settings.cookie_name)) && (this.settings.$tip_content.each(function(n) {
          ...
          for (var r = s; r--;) e.settings[i[r]] = parseInt(e.settings[i[r]], 10);
          e.create({
            $li: a,
            index: n
          })
      ...
      pos_default: function(t) {
        ...
        if (s && (this.settings.$next_tip.css("visibility", "hidden"), this.settings.$next_tip.show()), /body/i.test(this.settings.$target.selector)) this.settings.$li.length && this.pos_modal(e);
          ...
          this.bottom() ? (this.rtl ? this.settings.$next_tip.css({
            top: this.settings.$target.offset().top + i + this.settings.$target.outerHeight() + a,
            ...
            top: this.settings.$target.offset().top - this.settings.$next_tip.outerHeight() - i + a,
            ...
            left: this.settings.$target.outerWidth() + this.settings.$target.offset().left + n + r
          }), this.nub_position(e, this.settings.tip_settings.nub_position, "left")) : this.left() && (this.settings.$next_tip.css({
            top: this.settings.$target.offset().top + a,
            left: this.settings.$target.offset().left - this.settings.$next_tip.outerWidth() - n + r
      ...
      expose: function() {
        var n, i, s, a, r, o = "expose-" + this.random_str(6);
        ...
        }, r = null == s.attr("class") ? "" : s.attr("class"), s.css("z-index", parseInt(n.css("z-index")) + 1), "static" == a.position && s.css("position", "relative"), s.data("expose-css", a), s.data("orig-class", r), s.attr("class", r + " " + this.settings.expose_add_class), i.css({
          top: s.offset().top,
          left: s.offset().left,
          width: s.outerWidth(!0),
          height: s.outerHeight(!0)
        }), this.settings.modal && this.show_modal(), this.settings.$body.append(i), n.addClass(o), i.addClass(o), s.data("expose", o), this.settings.post_expose_callback(this.settings.$li.index(), this.settings.$next_tip, s), this.add_exposed(s), void 0)
      },
      un_expose: function() {
        var n, i, s, a, r, o = !1;
        ...
        return i.length < 1 ? (e.console && console.error("element not valid", i), !1) : (n = i.data("expose"), s = t("." + n), arguments.length > 1 && (o = arguments[1]), o === !0 ? t(".joyride-expose-wrapper,.joyride-expose-cover").remove() : s.remove(), a = i.data("expose-css"), "auto" == a.zIndex ? i.css("z-index", "") : i.css("z-index", a.zIndex), a.position != i.css("position") && ("static" == a.position ? i.css("position", "") : i.css("position", a.position)), r = i.data("orig-class"), i.attr("class", r), i.removeData("orig-classes"), i.removeData("expose"), i.removeData("expose-z-index"), this.remove_exposed(i), void 0)
      },
      ...
      remove_exposed: function(e) {
        ...
        for (e instanceof t ? n = e[0] : "string" == typeof e && (n = e), this.settings.exposed = this.settings.exposed || [], i = this.settings.exposed.length; i--;)
          if (this.settings.exposed[i] == n) return this.settings.exposed.splice(i, 1), void 0
      },
      center: function() {
        var n = t(e);
      ...
      corners: function(n) {
        var i = t(e),
          ...
          c = i.scrollTop();
        return c > a && (c = 0 > a ? 0 : a), o > l && (l = o), [n.offset().top < c, r < n.offset().left + n.outerWidth(), l < n.offset().top + n.outerHeight(), i.scrollLeft() > n.offset().left]
      },
      visible: function(t) {
    ...
    Foundation.libs.equalizer = {
      ...
      equalize: function(e) {
        ...
        if (0 !== i.length) {
          ...
          if (s.before_height_change(), e.trigger("before-height-change").trigger("before-height-change.fndth.equalizer"), i.height("inherit"), i.each(function() {
              var e = t(this);
              e.offset().top !== a && (n = !0)
            }), s.equalize_on_stack !== !1 || !n) {
    ...
    Foundation.libs.dropdown = {
      ...
      events: function() {
        ...
        i(this.scope).off(".dropdown").on("click.fndtn.dropdown", "[" + this.attr_name() + "]", function(e) {
          var s = i(this).data(n.attr_name(!0) + "-init") || n.settings;
          (!s.is_hover || Modernizr.touch) && (e.preventDefault(), n.toggle(t(this)))
        }).on("mouseenter.fndtn.dropdown", "[" + this.attr_name() + "], [" + this.attr_name() + "-content]", function(t) {
          var e, s, a = i(this);
          clearTimeout(n.timeout), a.data(n.data_attr()) ? (e = i("#" + a.data(n.data_attr())), s = a) : (e = a, s = i("[" + n.attr_name() + "='" + e.attr("id") + "']"));
          var r = s.data(n.attr_name(!0) + "-init") || n.settings;
          i(t.target).data(n.data_attr()) && r.is_hover && n.closeall.call(n), r.is_hover && n.open.apply(n, [e, s])
          ...
          n.timeout = setTimeout(function() {
            if (t.data(n.data_attr())) {
              ...
              var s = i("[" + n.attr_name() + '="' + i(this).attr("id") + '"]'),
                e = s.data(n.attr_name(!0) + "-init") || n.settings;
              e.is_hover && n.close.call(n, t)
            }
          }.bind(this), 150)
        }).on("click.fndtn.dropdown", function(e) {
          var s = i(e.target).closest("[" + n.attr_name() + "-content]");
          if (!i(e.target).data(n.data_attr()) && !i(e.target).parent().data(n.data_attr())) return !i(e.target).data("revealId") && s.length > 0 && (i(e.target).is("[" + n.attr_name() + "-content]") || t.contains(s.first()[0], e.target)) ? (e.stopPropagation(), void 0) : (n.close.call(n, i("[" + n.attr_name() + "-content]")), void 0)
      ...
      dirs: {
        ...
        top: function(t) {
          var e = Foundation.libs.dropdown,
            n = e.dirs._base.call(this, t),
            i = 8;
          return this.addClass("drop-top"), (t.outerWidth() < this.outerWidth() || e.small()) && e.adjust_pip(i, n), Foundation.rtl ? {
        ...
        bottom: function(t) {
          var e = Foundation.libs.dropdown,
            n = e.dirs._base.call(this, t),
            i = 8;
          return (t.outerWidth() < this.outerWidth() || e.small()) && e.adjust_pip(i, n), e.rtl ? {
            left: n.left - this.outerWidth() + t.outerWidth(),
      ...
      adjust_pip: function(t, e) {
        ...
        var i = ".f-dropdown.open:before",
          ...
          a = "left: " + t + "px;",
          r = "left: " + (t - 1) + "px;";
        n.insertRule ? (n.insertRule([i, "{", a, "}"].join(" "), this.rule_idx), n.insertRule([s, "{", r, "}"].join(" "), this.rule_idx + 1)) : (n.addRule(i, a, this.rule_idx), n.addRule(s, r, this.rule_idx + 1))
      },
      clear_idx: function() {
  ...
  function(t, e, n, i) {
    ...
    Foundation.libs.clearing = {
      ...
      events: function(i) {
        ...
        r.length > 0 && (this.scope = r), a(this.scope).off(".clearing").on("click.fndtn.clearing", "ul[" + this.attr_name() + "] li " + this.settings.open_selectors, function(t, e, n) {
          var e = e || a(this),
            n = n || e,
            i = e.next("li"),
            r = e.closest("[" + s.attr_name() + "]").data(s.attr_name(!0) + "-init"),
            o = a(t.target);
          t.preventDefault(), r || (s.init(), r = e.closest("[" + s.attr_name() + "]").data(s.attr_name(!0) + "-init")), n.hasClass("visible") && e[0] === n[0] && i.length > 0 && s.is_open(e) && (n = i, o = a("img", n)), s.open(o, e, n), s.update_paddles(n)
        ...
        if (!n.parent().hasClass("carousel")) {
          ...
          if (null != i[0]) {
            ...
            var a = this.S("#foundationClearingHolder"),
              r = n.data(this.attr_name(!0) + "-init"),
              o = {
                grid: '<div class="carousel">' + s + "</div>",
                viewing: r.templates.viewing
              },
              l = '<div class="clearing-assembled"><div>' + o.viewing + o.grid + "</div></div>",
      ...
      open: function(e, i, s) {
        function a() {
          setTimeout(function() {
            this.image_loaded(h, function() {
              1 !== h.outerWidth() || p ? r.call(this, h) : a.call(this)
            }.bind(this))
          }.bind(this), 100)
        }
        ...
        function r(e) {
          var n = t(e);
          n.css("visibility", "visible"), l.css("overflow", "hidden"), c.addClass("clearing-blackout"), d.addClass("clearing-container"), u.show(), this.fix_height(s).caption(o.S(".clearing-caption", u), o.S("img", s)).center_and_label(e, f).shift(i, s, function() {
      ...
      close: function(e, i) {
        ...
        var s, a, r = function(t) {
          ...
          o = t(n.body);
        return i === e.target && r && (o.css("overflow", ""), s = t("div", r).first(), a = t(".visible-img", s), a.trigger("close.fndtn.clearing"), this.settings.prev_index = 0, t("ul[" + this.attr_name() + "]", r).attr("style", "").closest(".clearing-blackout").removeClass("clearing-blackout"), s.removeClass("clearing-container"), a.hide(), a.trigger("closed.fndtn.clearing")), t("body").off("touchmove"), !1
      },
      is_open: function(t) {
      ...
      keydown: function(e) {
        var n = t(".clearing-blackout ul[" + this.attr_name() + "]"),
          ...
          s = this.rtl ? 39 : 37,
          a = 27;
        e.which === i && this.go(n, "next"), e.which === s && this.go(n, "prev"), e.which === a && this.S("a.clearing-close").trigger("click").trigger("click.fndtn.clearing")
      },
      nav: function(e, n) {
      ...
      go: function(t, e) {
        var n = this.S(".visible", t),
          i = n[e]();
        i.length && this.S("img", i).trigger("click", [n, i]).trigger("click.fndtn.clearing", [n, i]).trigger("change.fndtn.clearing")
      },
      shift: function(t, e, n) {
        var i, s = e.parent(),
          ...
          c = e.outerWidth(),
          d = {};
        e.index() === a || /skip/.test(r) ? /skip/.test(r) && (i = e.index() - this.settings.up_count, this.lock(), i > 0 ? (d[o] = -(i * c), s.animate(d, 300, this.unlock())) : (d[o] = 0, s.animate(d, 300, this.unlock()))) : /left/.test(r) ? (this.lock(), d[o] = l + c, s.animate(d, 300, this.unlock())) : /right/.test(r) && (this.lock(), d[o] = l - c, s.animate(d, 300, this.unlock())), n()
      },
      direction: function(t, e, n) {
        var i, s = this.S("li", t),
          a = s.outerWidth() + s.outerWidth() / 4,
          r = Math.floor(this.S(".clearing-container").outerWidth() / a) - 1,
          o = s.index(n);
        return this.settings.up_count = r, i = this.adjacent(this.settings.prev_index, o) ? o > r && o > this.settings.prev_index ? "right" : o > r - 1 && o <= this.settings.prev_index ? "left" : !1 : "skip", this.settings.prev_index = o, i
      },
    ...
    var s = function() {},
      a = function(s, a) {
        ...
        g.slides = function() {
          ...
          a.slide_number && (d.find("span:first").text(parseInt(e) + 1), d.find("span:last").text(g.slides().length)), a.bullets && (u.children().removeClass(a.bullets_active_class), t(u.children().get(e)).addClass(a.bullets_active_class))
          ...
          var r = t(i.get(v)),
            o = t(i.get(e));
          r.css("zIndex", 2), r.removeClass(a.active_slide_class), o.css("zIndex", 4).addClass(a.active_slide_class), m.trigger("before-slide-change.fndtn.orbit"), a.before_slide_change(), g.update_active_link(e);
          var l = function() {
            var t = function() {
              ...
              }]), a.after_slide_change(v, i.length)
            };
            m.height() != o.height() && a.variable_height ? m.animate({
              height: o.height()
            }, 250, "linear", t) : t()
          };
          if (1 === i.length) return l(), !1;
          var c = function() {
            "next" === s && f.next(r, o, l), "prev" === s && f.prev(r, o, l)
          };
          o.height() > m.height() && a.variable_height ? m.animate({
            height: o.height()
          }, 250, "linear", c) : c()
        }, g.next = function(t) {
          ...
          var t = new r(c.find("." + a.timer_container_class), a, g.timer_callback);
          return t
          ...
          g.build_markup(), a.timer && (p = g.create_timer(), Foundation.utils.image_loaded(this.slides().children("img"), p.start)), f = new l(a, m), "slide" === a.animation && (f = new o(a, m)), c.on("click", "." + a.next_class, g.next), c.on("click", "." + a.prev_class, g.prev), a.next_on_click && c.on("click", "." + a.slides_container_class + " [data-orbit-slide]", g.link_bullet), c.on("click", g.toggle_timer), a.swipe && c.on("touchstart.fndtn.orbit", function(t) {
            t.touches || (t = t.originalEvent);
            var e = {
              start_page_x: t.touches[0].pageX,
              start_page_y: t.touches[0].pageY,
      ...
      r = function(t, e, n) {
        ...
        this.update_progress = function(t) {
          ...
          l -= n - i;
          var o = 100 - 100 * (l / r);
          a.update_progress(o), t.trigger("timer-stopped.fndtn.orbit")
        }
      },
      o = function(e) {
        var n = e.animation_speed,
          ...
          a = {};
        a[s] = "0%", this.next = function(t, e, i) {
          t.animate({
            marginLeft: "-100%"
          }, n), e.animate(a, n, function() {
            t.css(s, "100%"), i()
          })
        }, this.prev = function(t, e, i) {
          t.animate({
            marginLeft: "100%"
          }, n), e.css(s, "-100%"), e.animate(a, n, function() {
            t.css(s, "100%"), i()
          })
        }
      },
    ...
    Foundation.libs.offcanvas = {
      ...
      events: function() {
        var t = this,
          ...
          i = "",
          s = "";
        "move" === this.settings.open_method ? (n = "move-", i = "right", s = "left") : "overlap" === this.settings.open_method && (n = "offcanvas-overlap"), e(this.scope).off(".offcanvas").on("click.fndtn.offcanvas", ".left-off-canvas-toggle", function(e) {
          t.click_toggle_class(e, n + i)
        }).on("click.fndtn.offcanvas", ".left-off-canvas-menu a", function(e) {
          var s = t.get_settings(e);
          s.close_on_click && t.hide.call(t, n + i, t.get_wrapper(e))
        }).on("click.fndtn.offcanvas", ".right-off-canvas-toggle", function(e) {
          t.click_toggle_class(e, n + s)
        }).on("click.fndtn.offcanvas", ".right-off-canvas-menu a", function(e) {
          var i = t.get_settings(e);
          i.close_on_click && t.hide.call(t, n + s, t.get_wrapper(e))
        }).on("click.fndtn.offcanvas", ".exit-off-canvas", function(e) {
          t.click_remove_class(e, n + s), i && t.click_remove_class(e, n + i)
        })
      },
      toggle: function(t, e) {
      ...
      events: function() {
        ...
        t(this.scope).off(".alert").on("click.fndtn.alert", "[" + this.attr_name() + "] a.close", function(t) {
          ...
          t.preventDefault(), Modernizr.csstransitions ? (i.addClass("alert-close"), i.on("transitionend webkitTransitionEnd oTransitionEnd", function() {
            n(this).trigger("close").trigger("close.fndtn.alert").remove(), s.callback()
  ...
  function(t, e, n, i) {
    ...
    Foundation.libs.reveal = {
      ...
      events: function() {
        ...
        }), e(n).on("touchend.fndtn.reveal click.fndtn.reveal", this.close_targets(), function(n) {
          if (n.preventDefault(), !t.locked) {
            var i = e("[" + t.attr_name() + "].open").data(t.attr_name(!0) + "-init"),
      ...
      open: function(e, n) {
        var i, s = this;
        e ? "undefined" != typeof e.selector ? i = s.S("#" + e.data(s.data_attr("reveal-id"))).first() : (i = s.S(this.scope), n = e) : i = s.S(this.scope);
        var a = i.data(s.attr_name(!0) + "-init");
        if (a = a || this.settings, i.hasClass("open") && e.attr("data-reveal-id") == i.attr("id")) return s.close(i);
        if (!i.hasClass("open")) {
          var r = s.S("[" + s.attr_name() + "].open");
          if ("undefined" == typeof i.data("css-top") && i.data("css-top", parseInt(i.css("top"), 10)).data("offset", this.cache_offset(i)), this.key_up_on(i), i.trigger("open").trigger("open.fndtn.reveal"), r.length < 1 && this.toggle_bg(i, !0), "string" == typeof n && (n = {
              url: n
            }), "undefined" != typeof n && n.url) {
            var o = "undefined" != typeof n.success ? n.success : null;
            t.extend(n, {
              success: function(e, n, l) {
                t.isFunction(o) && o(e, n, l), i.html(e), s.S(i).foundation("section", "reflow"), s.S(i).children().foundation(), r.length > 0 && s.hide(r, a.css.close), s.show(i, a.css.open)
              }
            }), t.ajax(n)
          } else r.length > 0 && this.hide(r, a.css.close), this.show(i, a.css.open)
        }
      },
      close: function(t) {
      ...
      hide: function(n, i) {
        if (i) {
          ...
          if (r.animate || (this.locked = !1), r.pop) {
            ...
            return setTimeout(function() {
              return n.animate(o, a.animation_speed, "linear", function() {
    ...
    Foundation.libs.interchange = {
        ...
        directives: {
          replace: function(e, n, i) {
            ...
            if (a != n) return /\.(gif|jpg|jpeg|tiff|png)([?#].*)?/i.test(n) ? (t(e).css("background-image", "url(" + n + ")"), e.data("interchange-last-path", n), i(n)) : t.get(n, function(t) {
              e.html(t), e.data(r.data_attr + "-last-path", n), i()
            })
          }
        }
      },
      ...
      parse_scenario: function(t) {
        ...
        if (e) var i = e[1],
          ...
          i = a[0],
          s = "";
        return [this.trim(i), this.convert_directive(s), this.trim(n)]
      },
      object: function(t) {
    ...
    Foundation.libs["magellan-expedition"] = {
      ...
      events: function() {
        ...
        n.set_expedition_position(), i(n.scope).off(".magellan").on("click.fndtn.magellan", "[" + n.add_namespace("data-magellan-arrival") + '] a[href^="#"]', function(e) {
          ...
          var i = t(this).closest("[" + n.attr_name() + "]"),
            ...
            r = t("a[name='" + a + "']");
          0 === r.length && (r = t("#" + a));
          var o = r.offset().top - s.destination_threshold + 1;
      ...
      set_expedition_position: function() {
        ...
        t("[" + this.attr_name() + "=fixed]", e.scope).each(function() {
          var n, i = t(this),
            s = i.data("magellan-expedition-init"),
            a = i.attr("styles");
          i.attr("style", ""), n = i.offset().top + s.threshold, i.data(e.data_attr("magellan-top-offset"), n), i.attr("style", a)
        })
      },
      update_expedition_positions: function() {
        ...
        t("[" + this.attr_name() + "=fixed]", n.scope).each(function() {
          ...
          if (i >= a) {
            var r = e.prev("[" + n.add_namespace("data-magellan-expedition-clone") + "]");
            0 === r.length && (r = e.clone(), r.removeAttr(n.attr_name()), r.attr(n.add_namespace("data-magellan-expedition-clone"), ""), e.before(r)), e.css({
              position: "fixed",
              top: s.fixed_top
            })
          } else e.prev("[" + n.add_namespace("data-magellan-expedition-clone") + "]").remove(), e.attr("style", "").removeClass("fixed")
        })
      },
      update_arrivals: function() {
        ...
        t("[" + this.attr_name() + "]", n.scope).each(function() {
          var e = t(this),
            ...
            a = n.offsets(e, i),
            r = e.find("[" + n.add_namespace("data-magellan-arrival") + "]"),
            o = !1;
          a.each(function(t, i) {
            if (i.viewport_offset >= i.top_offset) {
              var a = e.find("[" + n.add_namespace("data-magellan-arrival") + "]");
              return a.not(i.arrival).removeClass(s.active_class), i.arrival.addClass(s.active_class), o = !0, !0
            }
          }), o || r.removeClass(s.active_class)
        })
      },
      offsets: function(e, n) {
        ...
        return e.find("[" + i.add_namespace("data-magellan-arrival") + "]").map(function() {
          var n = t(this).data(i.data_attr("magellan-arrival")),
            r = t("[" + i.add_namespace("data-magellan-destination") + "=" + n + "]");
          if (r.length > 0) {
            var o = r.offset().top - s.destination_threshold - e.outerHeight();
            return {
              destination: r,
              arrival: t(this),
              top_offset: o,
      ...
      events: function() {
        ...
        n(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] > dd > a", function(i) {
          var s = n(this).closest("[" + e.attr_name() + "]"),
            ...
            d = n("dd > .content." + c.active_class, s);
          return i.preventDefault(), s.attr(e.attr_name()) && (r = r.add("[" + l + "] dd > .content"), o = o.add("[" + l + "] dd")), c.toggleable && a.is(d) ? (a.parent("dd").toggleClass(c.active_class, !1), a.toggleClass(c.active_class, !1), c.callback(a), a.triggerHandler("toggled", [s]), s.triggerHandler("toggled", [a]), void 0) : (c.multi_expand || (r.removeClass(c.active_class), o.removeClass(c.active_class)), a.addClass(c.active_class).parent().addClass(c.active_class), c.callback(a), a.triggerHandler("toggled", [s]), s.triggerHandler("toggled", [a]), void 0)
        })
      },
      off: function() {},
      reflow: function() {}
    ...
    Foundation.libs.topbar = {
      ...
      toggle: function(n) {
        ...
        s.breakpoint() && (s.rtl ? (r.css({
          ...
          left: "100%"
        })), s.S("li.moved", r).removeClass("moved"), i.data("index", 0), i.toggleClass("expanded").css("height", "")), a.scrolltop ? i.hasClass("expanded") ? i.parent().hasClass("fixed") && (a.scrolltop ? (i.parent().removeClass("fixed"), i.addClass("fixed"), s.S("body").removeClass("f-topbar-fixed"), e.scrollTo(0, 0)) : i.parent().removeClass("expanded")) : i.hasClass("fixed") && (i.parent().addClass("fixed"), i.removeClass("fixed"), s.S("body").addClass("f-topbar-fixed")) : (s.is_sticky(i, i.parent(), a) && i.parent().addClass("fixed"), i.parent().hasClass("fixed") && (i.hasClass("expanded") ? (i.addClass("fixed"), i.parent().addClass("expanded"), s.S("body").addClass("f-topbar-fixed")) : (i.removeClass("fixed"), i.parent().removeClass("expanded"), s.update_sticky_positioning())))
      },
      timer: null,
      events: function() {
        var n = this,
        ...
        i(this.scope).off(".topbar").on("click.fndtn.topbar", "[" + this.attr_name() + "] .toggle-topbar", function(t) {
          ...
          var s = i(this),
            a = i(e.target),
            r = s.closest("[" + n.attr_name() + "]"),
            o = r.data(n.attr_name(!0) + "-init");
          return a.data("revealId") ? (n.toggle(), void 0) : (n.breakpoint() || (!o.is_hover || Modernizr.touch) && (e.stopImmediatePropagation(), s.hasClass("hover") ? (s.removeClass("hover").find("li").removeClass("hover"), s.parents("li.hover").removeClass("hover")) : (s.addClass("hover"), t(s).siblings().removeClass("hover"), "A" === a[0].nodeName && a.parent().hasClass("has-dropdown") && e.preventDefault())), void 0)
          ...
          if (n.breakpoint()) {
            ...
            s.data("index", s.data("index") + 1), r.addClass("moved"), n.rtl ? (a.css({
          ...
          n.resize.call(n)
        }, 50)).trigger("resize").trigger("resize.fndtn.topbar"), i("body").off(".topbar").on("click.fndtn.topbar touchstart.fndtn.topbar", function(t) {
          ...
          var e = i(this),
            s = e.closest("[" + n.attr_name() + "]"),
            a = s.find("section, .section"),
            r = (s.data(n.attr_name(!0) + "-init"), e.closest("li.moved")),
            o = r.parent();
          s.data("index", s.data("index") - 1), n.rtl ? (a.css({
            right: -(100 * s.data("index")) + "%"
          }), a.find(">.name").css({
            right: 100 * s.data("index") + "%"
          })) : (a.css({
            ...
            left: 100 * s.data("index") + "%"
          })), 0 === s.data("index") ? s.css("height", "") : s.css("height", o.outerHeight(!0) + s.data("height")), setTimeout(function() {
            r.removeClass("moved")
          }, 300)
        })
      },
      resize: function() {
        ...
        t.S("[" + this.attr_name() + "]").each(function() {
          ...
          if (!t.breakpoint()) {
            var r = i.hasClass("expanded");
            i.css("height", "").removeClass("expanded").find("li").removeClass("hover"), r && t.toggle(i)
          }
      ...
      assemble: function(e) {
        ...
        s.detach(), n.S(".has-dropdown>a", s).each(function() {
          ...
          s.attr("href"), a.find(".title.back").length || (e = t('<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li>'), 1 == i.custom_back_text ? t("h5>a", e).html(i.back_text) : t("h5>a", e).html("&laquo; " + s.html()), a.prepend(e))
  ...
  function(t, e, n, i) {
    ...
    Foundation.libs.tab = {
      ...
      init: function(t, e, n) {
        var i = this,
          s = this.S;
        this.bindings(e, n), this.handle_location_hash_change(), s("[" + this.attr_name() + "] > .active > a", this.scope).each(function() {
      ...
      events: function() {
        var t = this,
          n = this.S;
        n(this.scope).off(".tab").on("click.fndtn.tab", "[" + this.attr_name() + "] > * > a", function(e) {
      ...
      handle_location_hash_change: function() {
        ...
        n("[" + this.attr_name() + "]", this.scope).each(function() {
          ...
          if (s.deep_linking) {
            ...
            if ("" != a) {
              var r = n(a);
              if (r.hasClass("content") && r.parent().hasClass("tab-content")) e.toggle_active_tab(t("[" + e.attr_name() + "] > * > a[href=" + a + "]").parent());
              else {
                var o = r.closest(".content").attr("id");
                o != i && e.toggle_active_tab(t("[" + e.attr_name() + "] > * > a[href=#" + o + "]").parent(), a)
              }
            } else
      ...
      toggle_active_tab: function(n, s) {
        ...
        if (a(this).data(this.data_attr("tab-content")) && (l = "#" + a(this).data(this.data_attr("tab-content")).split("#")[1], c = a(l)), u.deep_linking) {
          ...
          e.location.hash = s != i ? s : l, u.scroll_to_content ? s == i || s == l ? n.parent()[0].scrollIntoView() : a(l)[0].scrollIntoView() : (s == i || s == l) && t("body,html").scrollTop(h)
        }
        n.addClass(u.active_class).triggerHandler("opened"), d.removeClass(u.active_class), c.siblings().removeClass(u.active_class).end().addClass(u.active_class), u.callback(n), c.triggerHandler("toggled", [n]), r.triggerHandler("toggled", [c])
      },
      data_attr: function(t) {
        return this.namespace.length > 0 ? this.namespace + "-" + t : t
      },
    ...
    Foundation.libs.abide = {
      ...
      validate: function(t, e, n) {
        var i = this.parse_patterns(t),
          ...
          r = a.data(this.attr_name(!0) + "-init") || {},
          o = /submit/.test(e.type);
        a.trigger("validated").trigger("validated.fndtn.abide");
        for (var l = 0; s > l; l++)
          if (!i[l] && (o || n)) return r.focus_on_invalid && t[l].focus(), a.trigger("invalid").trigger("invalid.fndtn.abide"), this.S(t[l]).closest("[data-" + this.attr_name(!0) + "]").attr(this.invalid_attr, ""), !1;
        return (o || n) && a.trigger("valid").trigger("valid.fndtn.abide"), a.removeAttr(this.invalid_attr), n ? !1 : !0
      },
      ...
      valid_radio: function(t) {
        for (var e = t.getAttribute("name"), n = this.S(t).closest("[data-" + this.attr_name(!0) + "]").find("[name='" + e + "']"), i = n.length, s = !1, a = 0; i > a; a++) n[a].checked && (s = !0);
        for (var a = 0; i > a; a++) s ? this.S(n[a]).removeAttr(this.invalid_attr).parent().removeClass("error") : this.S(n[a]).attr(this.invalid_attr, "").parent().addClass("error");
        return s
      },
      valid_equal: function(t, e, i) {
        var s = n.getElementById(t.getAttribute(this.add_namespace("data-equalto"))).value,
          a = t.value,
          r = s === a;
        return r ? (this.S(t).removeAttr(this.invalid_attr), i.removeClass("error")) : (this.S(t).attr(this.invalid_attr, ""), i.addClass("error")), r
      },
  ...
  function(t, e) {
    ...
    Foundation.libs.tooltip = {
      ...
      events: function(e) {
        ...
        n.create(this.S(e)), t(this.scope).off(".tooltip").on("mouseenter.fndtn.tooltip mouseleave.fndtn.tooltip touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip", "[" + this.attr_name() + "]", function(e) {
          ...
          if (s.hasClass("open")) Modernizr.touch && /touchstart|MSPointerDown/i.test(e.type) && e.preventDefault(), n.hide(s);
            ...
            !a.disable_for_touch && Modernizr.touch && /touchstart|MSPointerDown/i.test(e.type) && (e.preventDefault(), i(a.tooltip_class + ".open").hide(), r = !0), /enter|over/i.test(e.type) ? this.timer = setTimeout(function() {
              n.showTip(s)
          ...
          return /mouse/i.test(e.type) && n.ie_touch(e) ? !1 : (("touch" != t(this).data("tooltip-open-event-type") || "mouseleave" != e.type) && ("mouse" == t(this).data("tooltip-open-event-type") && /MSPointerDown|touchstart/i.test(e.type) ? n.convert_to_touch(t(this)) : n.hide(t(this))), void 0)
      ...
      create: function(n) {
        ...
        var r = t(a(this.selector(n), t("<div></div>").html(n.attr("title")).html())),
          o = this.inheritable_classes(n);
        r.addClass(o).appendTo(s.append_to), Modernizr.touch && (r.append('<span class="tap-to-close">' + s.touch_close_text + "</span>"), r.on("touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip", function() {
          i.hide(n)
        })), n.removeAttr("title").attr("title", "")
      },
      reposition: function(e, n, i) {
        var s, a, r, o, l;
        if (n.css("visibility", "hidden").show(), s = e.data("width"), a = n.children(".nub"), r = a.outerHeight(), o = a.outerHeight(), this.small() ? n.css({
            width: "100%"
          }) : n.css({
            width: s ? s : "auto"
          ...
          }, l(n, e.offset().top + e.outerHeight() + 10, "auto", "auto", e.offset().left), this.small()) l(n, e.offset().top + e.outerHeight() + 10, "auto", "auto", 12.5, t(this.scope).width()), n.addClass("tip-override"), l(a, -r, "auto", "auto", e.offset().left);
        else {
          var c = e.offset().left;
  ...
  }(jQuery, window, window.document), UTIL = {
    exec: function(t, e) {
      var n = CAPPUCCINO,
        e = void 0 === e ? "init" : e;
      "" !== t && n[t] && "function" == typeof n[t][e] && n[t][e]()
    },
    init: function() {
      var t = document.body,
        e = t.getAttribute("data-controller"),
        n = t.getAttribute("data-action");
      UTIL.exec("common"), UTIL.exec(e), UTIL.exec(e, n)
    },
    sanitize: function(t) {
      var e, n = "(?:[^\"'>]|\"[^\"]*\"|'[^']*')*",
        i = new RegExp("<(?:!--(?:(?:-*[^->])*--+|-?)|script\\b" + n + ">[\\s\\S]*?</script\\s*" + "|style\\b" + n + ">[\\s\\S]*?</style\\s*" + "|/?[a-z]" + n + ")>", "gi");
      do e = t, t = t.replace(i, ""); while (t !== e);
      return t.replace(/</g, "&lt;")
    },
    enterFullScreen: function(t) {
      if (!(document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement)) {
        if (document.documentElement.requestFullscreen) return t.requestFullscreen();
        if (document.documentElement.msRequestFullscreen) return t.msRequestFullscreen();
        if (document.documentElement.mozRequestFullScreen) return t.mozRequestFullScreen();
        if (document.documentElement.webkitRequestFullscreen) return t.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT)
      }
    },
    ...
    handleCustomFileInput: function() {
      var t, e = window.File && window.FileReader && window.FileList && window.Blob ? !0 : !1;
      t = e && this.files[0] ? this.files[0].name : $(this).val().replace("C:\\fakepath\\", ""), t.length && $(this).parent().find(".input-text").text(t)
    },
    handleMultipleActiveButtons: function(t, e, n) {
      var i = $(n).parent().find(t);
      return $(n).hasClass(e) ? (i.removeAttr("disabled", "disabled"), $(n).removeClass(e), void 0) : ($(n).addClass(e), i.attr("disabled", "disabled"), $(n).removeAttr("disabled"), void 0)
    },
    handleOneActiveButton: function(t, e, n) {
      var i = $(n).parent().find(t);
      i.removeClass(e), $(n).addClass(e)
    },
    sendForm: function(t, e) {
      var n = $(e).find(".btn-orange"),
        i = $(e).find(".btn-orange").text();
      n.text("ОТПРАВКА..."), $.ajax("/wp-admin/admin-ajax.php", {
        data: t,
        method: "post"
      }).done(function(t) {
        n.text(i), $("#response-modal").find(".modal-body").html(t), $("#response-modal").foundation("reveal", "open")
      })
    },
    mixItUpDefaults: {
      load: {
...
$(document).foundation({
...
}), $().prettyEmbed(), $(".sendform").on("valid", function() {
  UTIL.sendForm($(this).serialize(), this)
}), $(".filter").removeAttr("disabled", "disabled"), $(".calculator button").removeAttr("disabled"), $(".big-form .btn-nice-grey").removeAttr("disabled"), $(".works-gallery").mixItUp(UTIL.mixItUpDefaults), $(".icon-fullscreen a").on("click", function(t) {
  $(this).hasClass("allow-full-width") && (t.preventDefault(), $(this).hasClass("fullscreen") ? UTIL.exitFullScreen() : UTIL.enterFullScreen(document.getElementById("design")))
}), $(".orbit-container").append($(".orbit-next.brown, .orbit-prev.brown").remove()), $(document).on("webkitfullscreenchange mozfullscreenchange fullscreenchange", function() {
  $("#design").toggleClass("fullscreen-slider"), $(".icon-fullscreen a").toggleClass("fullscreen"), $(".orbit-caption").fadeToggle("slow")
}), $(".smooth-scroll").on("click", function(t) {
  t.preventDefault(), this.hash || $(this).attr("data-href"), $("html, body").animate({
    scrollTop: $(this.hash).offset().top - 50
  }, 900)
}), $(".input-file input").on("change", UTIL.handleCustomFileInput), $(".videos-small").find(".pretty-embed").on("click", function(t) {
  t.preventDefault();
  var e = $(this).attr("data-pe-videoid"),
    n = $(this).parent().find(".feedback-text").html(),
    i = $(this).parent().find(".feedback-customer-name").html(),
    s = $(".video-large");
  return s.attr("data-pe-videoid", e), $(".feedback-content .feedback-text").html(n), $(".feedback-content .customer-name").html(i), $(".video-full").find(".pretty-embed").removeClass("play"), $().prettyEmbed(), !1
}), $("#slider").on("before-slide-change.fndtn.orbit", function() {
  $(".icon-fullscreen a").hasClass("fullscreen") || $(this).find(".orbit-caption").fadeOut()
}).on("after-slide-change.fndtn.orbit", function() {
  $(".icon-fullscreen a").hasClass("fullscreen") || $(this).find(".orbit-caption").fadeIn("fast")
}), $("#galley_item_details").on("click", ".ajax-prevnext", function(t) {
  t.preventDefault();
  var e = this.getAttribute("href");
  return e ? ($(".preloader").show(), $.ajax(e).done(function(t) {
    var e = $(t);
    e.find("img").hide(), setTimeout(function() {
      e.find("img").show(), $("#galley_item_details").html(e), $(".preloader").hide()
    }, 200)
  }), void 0) : !1
}), $(".more-works").on("click", function(t) {
  t.preventDefault();
  var e = $(this).attr("href"),
    ...
    s = i.find("span"),
    a = s.html();
  s.html("<strong>Загрузка...</strong>"), $.ajax(e + "/page/" + n).done(function(t) {
    var r = parseInt(n, 10) + 1;
    s.html(a), i.attr("data-page", parseInt(n, 10) + 1), $(".works-gallery").mixItUp("append", $(t)), $.ajax(e + "/page/" + r).error(function() {
      $(".more-works").remove()
    })
  })
}), $(".sertificate").on("click", function() {
  var t = $(".sertificates-lightbox").find(".lightbox-link"),
    e = $.makeArray(t),
    n = $(this).attr("data-num");
  $(e[n]).trigger("click")
}), $(".filter").on("click", function() {}), $(".calculator .btn-nice-grey").on("click", function(t) {
  t.preventDefault(), UTIL.handleOneActiveButton("button", "active", this), $(this).parent().find("input").val($(this).attr("data-cost"))
}), $(".big-form .btn-nice-grey").on("click", function(t) {
  t.preventDefault(), UTIL.handleOneActiveButton("button", "active", this), $(this).parent().find("input").val($(this).text())
}), $(".calculator").on("valid", function() {
  console.log("sdsd");
  var t = $(this).find('input[name="length"]').val().split("|"),
    e = $(this).find('input[name="fasad-material"]').val().split("|"),
    n = $(this).find('input[name="table-material"]').val().split("|"),
    i = $(this).find('input[name="boxes-count"]').val(),
    s = t[0] * parseInt(e[0], 10),
    a = t[0] * parseInt(n[0], 10),
    r = 649 * i,
    o = s + a + r,
    l = "ПРИМЕРНАЯ СТОИМОСТЬ ВАШЕЙ КУХНИ = " + o + " грн<h3>(В стоимость включены все преимущества, описанные на сайте)</h3>",
    c = 'ВНИМАНИЕ! Для расчета были предложены только самые популярные параметры.Нажмите кнопку "Узнать точную цену", и наш менеджер свяжется с Вами и уточнит индивидуальные пожелания для расчета стоимости.';
  $("#request-modal").find(".modal-title").html(l), $("#request-modal").find(".modal-body").text(c), $("#request-modal").find('input[name="block-name"]').val($(this).find(".btn-orange").attr("data-block-name")), $("#request-modal").find('input[name="calculator[fasad-material]"]').val(e[1]), $("#request-modal").find('input[name="calculator[table-material]"]').val(n[1]), $("#request-modal").find('input[name="calculator[length]"]').val(t), $("#request-modal").find('input[name="calculator[box-count]"]').val(i), $("#request-modal").find('input[name="calculator[cost]"]').val(o), $("#request-modal").foundation("reveal", "open")
}), $(".request-with-file").on("valid", function() {
  $(this).find(".btn-orange").text("ОТПРАВКА...")
}), $(".have-reveal-data").on("click", function() {
  var t = $(this).attr("data-modal-title"),
    e = $(this).attr("data-modal-body"),
    n = $(this).attr("data-modal-button"),
    i = $(this).attr("data-modal-success-message"),
    s = $(this).attr("data-designer");
  $("#request-modal").find(".modal-title").text(t), e && $("#request-modal").find(".modal-body").text(e), n && $("#request-modal").find(".btn-orange").text(n), i && $("#request-modal").find('input[name="succ_message"]').val(i), s && $("#request-modal").find('input[name="designer"]').val(s)
}), $("#request-modal").on("closed", function() {
  $(this).find(".modal-title").html("ОСТАВЬТЕ ЗАЯВКУ И МЫ ВАМ ПЕРЕЗВОНИМ"), $(this).find(".modal-body").html(""), $(this).find(".btn-orange").text("ОСТАВИТЬ ЗАЯВКУ"), $(this).find('input[name="block-name"]').val(""), $(this).find('input[name="calculator[fasad-material]"]').val(""), $(this).find('input[name="calculator[table-material]"]').val(""), $(this).find('input[name="calculator[length]"]').val(""), $(this).find('input[name="calculator[box-count]"]').val(""), $(this).find('input[name="succ_message"]').val("0"), $(this).find('input[name="designer"]').val("")
}), $(".big-form .btn-orange").on("click", function(t) {
  t.preventDefault();
  var e = $(".big-form").find('input[name="name"]'),
    n = $(".big-form").find('input[name="phone"]');
  if ("" == e.val() || "" == n.val()) return e.parent().addClass("error"), e.attr("data-invalid", ""), n.parent().addClass("error"), n.attr("data-invalid", ""), !1;
  var i = $(".big-form").find(".form-1").serialize() + "&" + $(".big-form").find(".form-2").serialize();
  UTIL.sendForm(i, $(".big-form"))
}), $("#map").on("click", function() {
  window.open($(".gm-link").attr("data-href"), '_blank')
}), $("#coffee-cup").appear().on("appear", function() {
  $(this).find("img").addClass("fadeInUp")
}), $(document).on("click", "[data-reveal-id]", function() {
  $("#request-modal").find('input[name="block-name"]').val($(this).attr("data-block-name"))
}), $(document).on("click", ".gallery-thumbs a", function(t) {
  t.preventDefault();
  var e = $(".gallery-full"),
    n = $(".gallery-full").find("a"),
    i = $(this),
    s = parseInt(i.attr("data-img-number"), 10),
    a = s + 1;
  $(".gallery-thumbs").find("a").removeClass("active"), i.addClass("active"), e.find("img").attr("src", i.attr("href")), n.attr("href", $('[data-img-number="' + a + '"]').attr("href")), n.attr("data-next-img-number", a)
}), $(document).on("click", ".gallery-full a", function(t) {
  t.preventDefault();
  var e = $(this),
    n = e.parent(),
    i = $(".gallery-thumbs"),
    s = i.find("a").last().attr("data-img-number");
  i.find("a").removeClass("active");
  var a = parseInt(e.attr("data-next-img-number"), 10);
  a > s && (a = 0);
  var r = i.find('[data-img-number="' + a + '"]').addClass("active").attr("href");
  n.find("img").attr("src", r), e.attr("data-next-img-number", ++a)
});
var flag = !1;
$("#achievements-1").appear().on("appear", function() {
  if (!flag) {
    flag = !0;
    var t = $(".achievements-numbers-animate .h1");
    t.each(function() {
      var t = $(this),
        e = parseInt(t.text(), 10),
        n = 1,
        i = 1,
        s = 100;
      e >= 200 && (s = 1), 5 >= e && (s = 500);
      var a = setInterval(function() {
        i - 1 == e ? clearInterval(a) : t.text(i), i += n
      }, s)
    })
  }
}), $(".js-show-video-modal").on("click", function(t) {
  t.preventDefault(), t.stopPropagation();
  var e = this.getAttribute("data-video-id");
  console.log(e);
  var n = $("#videoModal").find("iframe"),
    i = "http://www.youtube-nocookie.com/embed/" + e + "?rel=0";
  n.attr("data-src", i), $("#videoModal").foundation("reveal", "open")
}), $(".header-have-video").on("click", function(t) {
  t.stopPropagation(), $(this).find(".js-show-video-modal").trigger("click")
}), $("#response-modal").on("open", function() {
  yaCounter25156241.reachGoal("response-modal"), ga("send", "event", "response-modal", "open", "modal windows")
});
...
(function($) {
  $('#design .orbit-prev, #design .orbit-next').remove();
})($);
