      ...
      if (s._execAction("_processClick", 0, arguments), !s._mixing || s.animation.queue && s._queue.length < s.animation.queueLimit) {
        ...
        if ("filter" === i) {
          ...
          s.controls.toggleFilterButtons ? (
            s._buildToggleArray(),
            n.hasClass(s.controls.activeClass) ? (a(n, i, !0),
              o = s._toggleArray.indexOf(l),
              s._toggleArray.splice(o, 1)) : (a(n, i),
              s._toggleArray.push(l)),
              s._toggleArray = t.grep(s._toggleArray,
                function(t) {return t;}
                ),
              s._toggleString = s._toggleArray.join(c),
              s.filter(s._toggleString)) : n.hasClass(s.controls.activeClass) || (t(s.selectors.filter).removeClass(s.controls.activeClass), a(n, i), s.filter(l))
        }
